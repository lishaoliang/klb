...
/// @struct klb_multiplex_ops_t
/// @brief  复用对象接口
typedef struct klb_multiplex_ops_t_
{
    /// @brief 当移除之后, 可以销毁时机
...
KLB_API int klb_multiplex_push_socket(klb_multiplex_t* p_multi, klb_socket_t* p_socket, const klb_multiplex_ops_t* p_ops);
