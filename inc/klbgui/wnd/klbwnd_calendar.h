...
/// @brief set/get title
KLB_API void klbwnd_calendar_set_title(klb_wnd_t* p_wnd, const char* p_title);
KLB_API const sds klbwnd_calendar_get_title(klb_wnd_t* p_wnd);


/// @brief set/get value
KLB_API void klbwnd_calendar_set_value(klb_wnd_t* p_wnd, const char* p_value);
KLB_API const sds klbwnd_calendar_get_value(klb_wnd_t* p_wnd);
