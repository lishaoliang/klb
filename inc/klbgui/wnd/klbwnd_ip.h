...
KLB_API void klbwnd_ip_css_copy(klbwnd_ip_css_t* p_dst, klbwnd_ip_css_t* p_src);
...
/// @brief 设置/获取序号
KLB_API void klbwnd_ip_set_index(klb_wnd_t* p_wnd, int index);
KLB_API int  klbwnd_ip_get_index(klb_wnd_t* p_wnd);
