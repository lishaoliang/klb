...
/// @brief set/get title
KLB_API void klbwnd_list_set_title(klb_wnd_t* p_wnd, const char* p_title);
KLB_API const sds klbwnd_list_get_title(klb_wnd_t* p_wnd);


/// @brief set/get value
KLB_API void klbwnd_list_set_value(klb_wnd_t* p_wnd, const char* p_value);
KLB_API const sds klbwnd_list_get_value(klb_wnd_t* p_wnd);
