...
{
    int16_t top;            ///< "margin-top" 上外边距
    int16_t right;          ///< "margin-right" 右外边距
    int16_t bottom;         ///< "margin-bottom" 下外边距
    int16_t left;           ///< "margin-left" 左外边距
}klbuicss_margin_t;
...
{
    int16_t top;            ///< "padding-top" 上内边距
    int16_t right;          ///< "padding-right" 右内边距
    int16_t bottom;         ///< "padding-bottom" 下内边距
    int16_t left;           ///< "padding-left" 左内边距
}klbuicss_padding_t;
...
{
    int16_t max_height;         ///< ["max-height"] 最大高度
    int16_t max_width;          ///< ["max-width"] 最大宽度
    int16_t min_height;         ///< ["min-height"] 最小高度
    int16_t min_width;          ///< ["min-width"] 最小宽度
}klbuicss_box_t;


/// @struct klbuicss_layout_t
/// @brief  布局属性
...
//       2).使用CSS-MINI, 精简每个属性占用的字节数: eg. 将 klbuicss_padding_t.top 属性 由"int" 修改为 "int16_t"
