...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_view_quit_attribute(klbwnd_view_t* p_view);
...
static void klbwnd_view_on_paint_status(klb_wnd_t* p_wnd, klbwnd_view_t* p_view, klbwnd_view_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
void klbwnd_view_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_view->title = sdscpy(p_view->title, p_title);
}
...
void klbwnd_view_css_quit(klbwnd_view_css_t* p_css)
{
...
void klbwnd_view_quit(klb_wnd_t* p_wnd)
{
    klbwnd_view_t* p_view = (klbwnd_view_t*)p_wnd->ctrl;
