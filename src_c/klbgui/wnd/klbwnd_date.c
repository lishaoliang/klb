...
void klbwnd_date_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_date->title = sdscpy(p_date->title, p_title);
}
...
void klbwnd_date_set_value(klb_wnd_t* p_wnd, const char* p_value)
{
    klbwnd_date_t* p_date = (klbwnd_date_t*)p_wnd->ctrl;

    p_date->value = sdscpy(p_date->value, p_value);
}

const sds klbwnd_date_get_value(klb_wnd_t* p_wnd)
{
    klbwnd_date_t* p_date = (klbwnd_date_t*)p_wnd->ctrl;
...
static void klbwnd_date_init_attribute(klbwnd_date_t* p_date)
{
...
void klbwnd_date_init(klb_wnd_t* p_wnd, klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // 
    klbwnd_date_init_attribute(p_date);
}
