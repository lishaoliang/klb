...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_animation_quit_attribute(klbwnd_animation_t* p_ani);
...
static void klbwnd_animation_on_paint_status(klb_wnd_t* p_wnd, klbwnd_animation_t* p_ani, klbwnd_animation_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
static int klbwnd_animation_on_paint(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_animation_on_paint_status(p_wnd, p_ani, p_css, &p_css->disable, &paint_rect);
    }
    else if (KLB_WND_STATUS_FOCUS & p_wnd->state.status)
    {
        klbwnd_animation_on_paint_status(p_wnd, p_ani, p_css, &p_css->focus, &paint_rect);
    }
    else
    {
...
void klbwnd_animation_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_ani->title = sdscpy(p_ani->title, p_title);
}
...
void klbwnd_animation_set_value(klb_wnd_t* p_wnd, const char* p_value)
{
    ...
    p_ani->value = sdscpy(p_ani->value, p_value);
}
...
static void klbwnd_animation_init_attribute(klbwnd_animation_t* p_ani)
{
    p_ani->title = sdsempty();
    p_ani->value = sdsempty();
}
...
void klbwnd_animation_css_quit(klbwnd_animation_css_t* p_css)
{
...
void klbwnd_animation_init(klb_wnd_t* p_wnd, klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_control = klbwnd_animation_on_control; // 这里指定
    ...
    // 
    klbwnd_animation_init_attribute(p_ani);
}

void klbwnd_animation_quit(klb_wnd_t* p_wnd)
{
    klbwnd_animation_t* p_ani = (klbwnd_animation_t*)p_wnd->ctrl;
