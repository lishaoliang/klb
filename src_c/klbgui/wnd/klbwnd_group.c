...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_group_quit_attribute(klbwnd_group_t* p_group);
...
static void klbwnd_group_on_paint_status(klb_wnd_t* p_wnd, klbwnd_group_t* p_group, klbwnd_group_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
void klbwnd_group_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_group->title = sdscpy(p_group->title, p_title);
}
...
void klbwnd_group_set_value(klb_wnd_t* p_wnd, const char* p_value)
{
    ...
    p_group->value = sdscpy(p_group->value, p_value);
}
...
{
    p_group->title = sdsempty();
    p_group->value = sdsempty();
}
...
void klbwnd_group_css_quit(klbwnd_group_css_t* p_css)
{
...
void klbwnd_group_quit(klb_wnd_t* p_wnd)
{
    klbwnd_group_t* p_group = (klbwnd_group_t*)p_wnd->ctrl;
