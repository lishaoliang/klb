...
static void klbwnd_progress_on_paint_status(klb_wnd_t* p_wnd, klbwnd_progress_t* p_prog, klbwnd_progress_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
void klbwnd_progress_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_prog->title = sdscpy(p_prog->title, p_title);
}
...
void klbwnd_progress_css_quit(klbwnd_progress_css_t* p_css)
{
...
void klbwnd_progress_quit(klb_wnd_t* p_wnd)
{
    klbwnd_progress_t* p_prog = (klbwnd_progress_t*)p_wnd->ctrl;
