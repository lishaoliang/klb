...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_button_quit_attribute(klbwnd_button_t* p_btn);
...
static void klbwnd_button_on_paint_status(klb_wnd_t* p_wnd, klbwnd_button_t* p_btn, klbwnd_button_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
static int klbwnd_button_on_paint(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_button_on_paint_status(p_wnd, p_btn, p_css, &p_css->focus, &paint_rect);
    }
    else
    {
        klbwnd_button_on_paint_status(p_wnd, p_btn, p_css, &p_css->normal, &paint_rect);
    }
...
void klbwnd_button_init(klb_wnd_t* p_wnd, klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_control = klbwnd_button_on_control;    // 这里指定
