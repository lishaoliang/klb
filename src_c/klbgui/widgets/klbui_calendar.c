...
typedef struct klbui_calendar_t_
{
    ...
    klbwnd_calendar_css_t*  p_globalcss;    ///< 全局公共的CSS
    klbwnd_calendar_css_t*  p_mycss;        ///< 私有的CSS
...
static void klbui_calendar_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出基础部分
    klbwnd_calendar_quit(p_wnd);

    // 退出css
    if (NULL != p_cal->p_mycss)
    {
        klbwnd_calendar_css_quit(p_cal->p_mycss);
...
{
    klbwnd_calendar_css_t* p_css = (klbwnd_calendar_css_t*)ptr;
    klbwnd_calendar_css_quit(p_css);
    KLB_FREE(p_css);
}
...
static void klbui_calendar_init_globalcss(klb_gui_t* p_gui)
{
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_kcalendar);

    // 添加全局 CSS 
    klbwnd_calendar_css_t* p_css = KLB_MALLOCZ(klbwnd_calendar_css_t, 1, 0);
    klbwnd_calendar_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_kcalendar, p_css, destroy_globalcss_klbwnd_calendar);
    ...
    // 外边距 margin
    KLBUI_GLOBAL_calendar_bind("margin", globalcss_klbui_calendar_margin);
    KLBUI_GLOBAL_calendar_bind("margin-top", globalcss_klbui_calendar_margin_top);
    KLBUI_GLOBAL_calendar_bind("margin-right", globalcss_klbui_calendar_margin_right);
    KLBUI_GLOBAL_calendar_bind("margin-bottom", globalcss_klbui_calendar_margin_bottom);
    KLBUI_GLOBAL_calendar_bind("margin-left", globalcss_klbui_calendar_margin_left);

    // 内边距 padding
    KLBUI_GLOBAL_calendar_bind("padding", globalcss_klbui_calendar_padding);
    KLBUI_GLOBAL_calendar_bind("padding-top", globalcss_klbui_calendar_padding_top);
    KLBUI_GLOBAL_calendar_bind("padding-right", globalcss_klbui_calendar_padding_right);
    KLBUI_GLOBAL_calendar_bind("padding-bottom", globalcss_klbui_calendar_padding_bottom);
    KLBUI_GLOBAL_calendar_bind("padding-left", globalcss_klbui_calendar_padding_left);

    // 文本颜色 color
    KLBUI_GLOBAL_calendar_bind("color", globalcss_klbui_calendar_text_color);
    KLBUI_GLOBAL_calendar_bind("color:focus", globalcss_klbui_calendar_text_color_focus);
    KLBUI_GLOBAL_calendar_bind("color:disable", globalcss_klbui_calendar_text_color_disable);

    // 文本对齐 text-align
    KLBUI_GLOBAL_calendar_bind("text-align", globalcss_klbui_calendar_text_align);
    KLBUI_GLOBAL_calendar_bind("text-align:focus", globalcss_klbui_calendar_text_align_focus);
    KLBUI_GLOBAL_calendar_bind("text-align:disable", globalcss_klbui_calendar_text_align_disable);

    // 字体大小 font-size
    KLBUI_GLOBAL_calendar_bind("font-size", globalcss_klbui_calendar_font_size);
    KLBUI_GLOBAL_calendar_bind("font-size:focus", globalcss_klbui_calendar_font_size_focus);
    KLBUI_GLOBAL_calendar_bind("font-size:disable", globalcss_klbui_calendar_font_size_disable);

    // 背景色 background-color
    KLBUI_GLOBAL_calendar_bind("background-color", globalcss_klbui_calendar_background_color);
    KLBUI_GLOBAL_calendar_bind("background-color:focus", globalcss_klbui_calendar_background_color_focus);
    KLBUI_GLOBAL_calendar_bind("background-color:disable", globalcss_klbui_calendar_background_color_disable);

    // 背景图片 background-image
    KLBUI_GLOBAL_calendar_bind("background-image", globalcss_klbui_calendar_background_image);
    KLBUI_GLOBAL_calendar_bind("background-image:focus", globalcss_klbui_calendar_background_image_focus);
    KLBUI_GLOBAL_calendar_bind("background-image:disable", globalcss_klbui_calendar_background_image_disable);

    // 边框的宽度 border-width
    KLBUI_GLOBAL_calendar_bind("border-width", globalcss_klbui_calendar_border_width);
    KLBUI_GLOBAL_calendar_bind("border-width:focus", globalcss_klbui_calendar_border_width_focus);
    KLBUI_GLOBAL_calendar_bind("border-width:disable", globalcss_klbui_calendar_border_width_disable);

    // 边框的颜色 border-color
    KLBUI_GLOBAL_calendar_bind("border-color", globalcss_klbui_calendar_border_color);
    KLBUI_GLOBAL_calendar_bind("border-color:focus", globalcss_klbui_calendar_border_color_focus);
    KLBUI_GLOBAL_calendar_bind("border-color:disable", globalcss_klbui_calendar_border_color_disable);
}
...
{
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBUI_kcalendar);
    if (NULL != ptr)
    {
    ...
    KLBUI_calendar_bind("margin-bottom", on_klbui_calendar_margin_bottom);
    KLBUI_calendar_bind("margin-left", on_klbui_calendar_margin_left);

    // 内边距 padding
    KLBUI_calendar_bind("padding", on_klbui_calendar_padding);
    KLBUI_calendar_bind("padding-top", on_klbui_calendar_padding_top);
    KLBUI_calendar_bind("padding-right", on_klbui_calendar_padding_right);
    KLBUI_calendar_bind("padding-bottom", on_klbui_calendar_padding_bottom);
    KLBUI_calendar_bind("padding-left", on_klbui_calendar_padding_left);

    // 文本颜色 color
    KLBUI_calendar_bind("color", on_klbui_calendar_text_color);
    KLBUI_calendar_bind("color:focus", on_klbui_calendar_text_color_focus);
    KLBUI_calendar_bind("color:disable", on_klbui_calendar_text_color_disable);

    // 文本对齐 text-align
    KLBUI_calendar_bind("text-align", on_klbui_calendar_text_align);
    KLBUI_calendar_bind("text-align:focus", on_klbui_calendar_text_align_focus);
    KLBUI_calendar_bind("text-align:disable", on_klbui_calendar_text_align_disable);

    // 字体大小 font-size
    KLBUI_calendar_bind("font-size", on_klbui_calendar_font_size);
    KLBUI_calendar_bind("font-size:focus", on_klbui_calendar_font_size_focus);
    KLBUI_calendar_bind("font-size:disable", on_klbui_calendar_font_size_disable);

    // 背景色 background-color
    KLBUI_calendar_bind("background-color", on_klbui_calendar_background_color);
    KLBUI_calendar_bind("background-color:focus", on_klbui_calendar_background_color_focus);
    KLBUI_calendar_bind("background-color:disable", on_klbui_calendar_background_color_disable);

    // 背景图片 background-image
    KLBUI_calendar_bind("background-image", on_klbui_calendar_background_image);
    KLBUI_calendar_bind("background-image:focus", on_klbui_calendar_background_image_focus);
    KLBUI_calendar_bind("background-image:disable", on_klbui_calendar_background_image_disable);

    // 边框的宽度 border-width
    KLBUI_calendar_bind("border-width", on_klbui_calendar_border_width);
    KLBUI_calendar_bind("border-width:focus", on_klbui_calendar_border_width_focus);
    KLBUI_calendar_bind("border-width:disable", on_klbui_calendar_border_width_disable);

    // 边框的颜色 border-color
    KLBUI_calendar_bind("border-color", on_klbui_calendar_border_color);
    KLBUI_calendar_bind("border-color:focus", on_klbui_calendar_border_color_focus);
    KLBUI_calendar_bind("border-color:disable", on_klbui_calendar_border_color_disable);

    //////////////////////////////////////////////
    // 自定义方法

    KLBUI_calendar_bind("title", on_klbui_calendar_title);
    KLBUI_calendar_bind("value", on_klbui_calendar_value);
}
...
{
    klbui_calendar_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
