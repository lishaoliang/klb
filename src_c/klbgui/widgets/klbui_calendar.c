...
static void klbui_calendar_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    klbwnd_calendar_css_quit(&p_cal->css);
...
{
    klbuicssex_margin_top(&(p_cal->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_right(&(p_cal->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_bottom(&(p_cal->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_left(&(p_cal->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding(&(p_cal->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_top(&(p_cal->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_right(&(p_cal->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_bottom(&(p_cal->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_left(&(p_cal->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_cal->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_cal->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_cal->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_cal->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_cal->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_cal->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_cal->css.normal.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_cal->css.focus.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_cal->css.disable.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_cal->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_cal->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_cal->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_cal->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_cal->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_cal->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_cal->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_cal->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_cal->css.disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_cal->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_cal->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_cal->css.disable.border), p_wnd, method, p_in, p_out);
}
...
klb_wnd_t* klbui_calendar_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // css
    klbwnd_calendar_css_init(&p_cal->css, p_gui);
    klbwnd_calendar_set_css(p_wnd, &p_cal->css);
