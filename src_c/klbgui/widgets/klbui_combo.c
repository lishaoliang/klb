...
static int klbui_combo_on_command(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_combo_t* p_combo = (klbui_combo_t*)p_wnd->ctrl;
...
klb_wnd_t* klbui_combo_create(int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_command = klbui_combo_on_command;
