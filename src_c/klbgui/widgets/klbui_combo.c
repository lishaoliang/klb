...
typedef struct klbui_combo_t_
{
    ...
    klbwnd_combo_css_t* p_globalcss;    ///< 全局公共的CSS
    klbwnd_combo_css_t* p_mycss;        ///< 私有的CSS
...
static void klbui_combo_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_combo_css_quit(p_combo->p_mycss);
...
static void globalcss_klbui_combo_text_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_text_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_text_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
...
static void klbui_combo_init_globalcss(klb_gui_t* p_gui)
{
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_kcombo);

    // 添加全局 CSS 
    klbwnd_combo_css_t* p_css = KLB_MALLOCZ(klbwnd_combo_css_t, 1, 0);
    klbwnd_combo_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_kcombo, p_css, destroy_globalcss_klbwnd_combo);
    ...
    // 文本颜色 color
    KLBUI_GLOBAL_combo_bind("color", globalcss_klbui_combo_text_color);
    KLBUI_GLOBAL_combo_bind("color:focus", globalcss_klbui_combo_text_color_focus);
    KLBUI_GLOBAL_combo_bind("color:disable", globalcss_klbui_combo_text_color_disable);
    ...
    KLBUI_GLOBAL_combo_bind("text-align:disable", globalcss_klbui_combo_text_align_disable);
    ...
    KLBUI_GLOBAL_combo_bind("font-size:disable", globalcss_klbui_combo_font_size_disable);
    ...
    KLBUI_GLOBAL_combo_bind("background-color:disable", globalcss_klbui_combo_background_color_disable);
    ...
    KLBUI_GLOBAL_combo_bind("background-image:disable", globalcss_klbui_combo_background_image_disable);
    ...
    KLBUI_GLOBAL_combo_bind("border-width:disable", globalcss_klbui_combo_border_width_disable);
    ...
    KLBUI_GLOBAL_combo_bind("border-color:disable", globalcss_klbui_combo_border_color_disable);
}
...
{
    klbui_combo_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
