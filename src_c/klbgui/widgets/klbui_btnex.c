...
static void klbui_btnex_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    klbwnd_btnex_css_quit(&p_btnex->css);
...
{
    klbuicssex_margin(&(p_btnex->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_top(&(p_btnex->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_right(&(p_btnex->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_bottom(&(p_btnex->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_left(&(p_btnex->css.margin), p_wnd, method, p_in, p_out);
}

static void on_klbui_btnex_padding(klb_wnd_t* p_wnd, klbui_btnex_t* p_btnex, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_padding(&(p_btnex->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_top(&(p_btnex->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_right(&(p_btnex->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_bottom(&(p_btnex->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_left(&(p_btnex->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_btnex->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_btnex->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_btnex->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_btnex->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_btnex->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_btnex->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_btnex->css.normal.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_btnex->css.focus.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_btnex->css.disable.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_btnex->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_btnex->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_btnex->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_btnex->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_btnex->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_btnex->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_btnex->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_btnex->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_btnex->css.disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_btnex->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_btnex->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_btnex->css.disable.border), p_wnd, method, p_in, p_out);
}
...
static void klbui_btnex_init_func_map(klb_wnd_t* p_wnd, klbui_btnex_t* p_btnex, klb_gui_t* p_gui)
{
    ...
    p_btnex->p_func_map = ptr;
    klb_gui_css_map_append_std_function(ptr, p_btnex); // 添加公共方法
...
klb_wnd_t* klbui_btnex_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // css
    klbwnd_btnex_css_init(&p_btnex->css, p_gui);
    klbwnd_btnex_set_css(p_wnd, &p_btnex->css);
