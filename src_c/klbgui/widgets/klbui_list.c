...
static int klbui_list_on_paint(klb_wnd_t* p_wnd)
{
    klbui_list_t* p_list = (klbui_list_t*)p_wnd->ctrl;
...
static int klbui_list_on_control(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_list_t* p_list = (klbui_list_t*)p_wnd->ctrl;
    ...
    {
    case KLB_GUI_PAINT:
        return klbui_list_on_paint(p_wnd);
    default:
        break;
    }
...
static int klbui_list_on_command(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_list_t* p_list = (klbui_list_t*)p_wnd->ctrl;
...
klb_wnd_t* klbui_list_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_control = klbui_list_on_control;
    p_wnd->vtable.on_command = klbui_list_on_command;
