...
static void on_klbui_ip_visibility(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
...
static void klbui_ip_init_func_map(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, klb_gui_t* p_gui)
{
    ...
    // 显隐
    KLBUI_ip_bind("visibility", on_klbui_ip_visibility); // 显示/隐藏
