...
static void klbui_picture_destroy(klb_wnd_t* p_wnd)
{
	...
	// 退出css
	klbwnd_picture_css_quit(&p_pic->css);
...
{
	klbuicssex_margin(&(p_pic->css.margin), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_margin_top(&(p_pic->css.margin), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_margin_right(&(p_pic->css.margin), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_margin_bottom(&(p_pic->css.margin), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_margin_left(&(p_pic->css.margin), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_padding(&(p_pic->css.padding), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_padding_top(&(p_pic->css.padding), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_padding_right(&(p_pic->css.padding), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_padding_bottom(&(p_pic->css.padding), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_padding_left(&(p_pic->css.padding), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_text_color(&(p_pic->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_text_color(&(p_pic->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_text_color(&(p_pic->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_text_align(&(p_pic->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_text_align(&(p_pic->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_text_align(&(p_pic->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_font_size(&(p_pic->css.normal.font), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_font_size(&(p_pic->css.focus.font), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_font_size(&(p_pic->css.disable.font), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_background_color(&(p_pic->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_background_color(&(p_pic->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_background_color(&(p_pic->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_background_image(&(p_pic->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_background_image(&(p_pic->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_background_image(&(p_pic->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_border_width(&(p_pic->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_border_width(&(p_pic->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_border_width(&(p_pic->css.disable.border), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_border_color(&(p_pic->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_border_color(&(p_pic->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
	klbuicssex_border_color(&(p_pic->css.disable.border), p_wnd, method, p_in, p_out);
}
...
static void klbui_picture_init_func_map(klb_wnd_t* p_wnd, klbui_picture_t* p_pic, klb_gui_t* p_gui)
{
	...
	// 显隐
	KLBUI_picture_bind("visibility", on_klbui_picture_visibility); // 显示/隐藏
...
klb_wnd_t* klbui_picture_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
	...
	// css
	klbwnd_picture_css_init(&p_pic->css, p_gui);
	klbwnd_picture_set_css(p_wnd, &p_pic->css);
