...
{
	klbwnd_picture_t		picture;		///< 必须首位, 保持内存一致

    klbwnd_picture_css_t*   p_globalcss;    ///< 全局公共的CSS
    klbwnd_picture_css_t*   p_mycss;        ///< 私有的CSS
...
static void klbui_picture_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    if (NULL != p_pic->p_mycss)
    {
        klbwnd_picture_css_quit(p_pic->p_mycss);
        KLB_FREE(p_pic->p_mycss);
    }
...
// 新建私有CSS
static void new_my_css_klbui_picture(klb_wnd_t* p_wnd)
{
    klbui_picture_t* p_pic = (klbui_picture_t*)p_wnd->ctrl;

    if (NULL == p_pic->p_mycss)
    {
        p_pic->p_mycss = KLB_MALLOCZ(klbwnd_picture_css_t, 1, 0);

        // 从新建时, 复制公共参数; 后面分开
        klbwnd_picture_css_copy(p_pic->p_mycss, p_pic->p_globalcss);
        klbwnd_picture_set_css(p_wnd, p_pic->p_mycss);
    }
}

// 获取当前 CSS
static klbwnd_picture_css_t* get_css_klbui_picture(klb_wnd_t* p_wnd)
{
    klbui_picture_t* p_pic = (klbui_picture_t*)p_wnd->ctrl;
    return (NULL != p_pic->p_mycss) ? p_pic->p_mycss : p_pic->p_globalcss;
}

// 检查方法, 并获取当前的CSS
static klbwnd_picture_css_t* check_css_klbui_picture(klb_wnd_t* p_wnd, int method)
{
    if (KLBUI_CSSEX_set == method)
    {
        // 只要是 set-css 相关方法, 立即转换为使用私有CSS
        new_my_css_klbui_picture(p_wnd);
    }

    return get_css_klbui_picture(p_wnd);
}

//////////////////////////////////////////////////////////////////////////
// global CSS 方法 - 公共CSS属性

static void globalcss_klbui_picture_margin(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_margin(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_margin_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_margin_top(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_margin_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_margin_right(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_margin_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_margin_bottom(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_margin_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_margin_left(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_padding(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_padding(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_padding_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_padding_top(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_padding_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_padding_right(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_padding_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_padding_bottom(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_padding_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_padding_left(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_text_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_text_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_text_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_text_color(&(p_css->disable.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_text_align(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_text_align(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_text_align_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_text_align(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_text_align_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_text_align(&(p_css->disable.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_font_size(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_font_size(&(p_css->normal.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_font_size_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_font_size(&(p_css->focus.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_font_size_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_font_size(&(p_css->disable.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_background_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_background_color(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_background_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_background_color(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_background_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_background_color(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_background_image(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_background_image(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_background_image_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_background_image(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_background_image_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_background_image(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_border_width(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_border_width(&(p_css->normal.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_border_width_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_border_width(&(p_css->focus.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_border_width_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_border_width(&(p_css->disable.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_border_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_border_color(&(p_css->normal.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_border_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbuicssex_border_color(&(p_css->focus.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_picture_border_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
...
/// @brief 销毁 全局公共CSS属性
static void destroy_globalcss_klbwnd_picture(void* ptr)
{
    klbwnd_picture_css_t* p_css = (klbwnd_picture_css_t*)ptr;
    klbwnd_picture_css_quit(p_css);
    KLB_FREE(p_css);
}

#define KLBUI_GLOBAL_pic_bind(KEY_, FUNC_) { klb_map_set_ptr(ptr, (KEY_), (void*)(FUNC_), NULL); }

static void klbui_picture_init_globalcss(klb_gui_t* p_gui)
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBUI_kpicture);
    if (NULL != ptr)
    {
        return;
    }
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_kpicture);

    // 添加全局 CSS 
    klbwnd_picture_css_t* p_css = KLB_MALLOCZ(klbwnd_picture_css_t, 1, 0);
    klbwnd_picture_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_kpicture, p_css, destroy_globalcss_klbwnd_picture);
    ...
    // 文本颜色 color
    KLBUI_GLOBAL_pic_bind("color", globalcss_klbui_picture_text_color);
    KLBUI_GLOBAL_pic_bind("color:focus", globalcss_klbui_picture_text_color_focus);
    KLBUI_GLOBAL_pic_bind("color:disable", globalcss_klbui_picture_text_color_disable);

    // 文本对齐 text-align
    KLBUI_GLOBAL_pic_bind("text-align", globalcss_klbui_picture_text_align);
    KLBUI_GLOBAL_pic_bind("text-align:focus", globalcss_klbui_picture_text_align_focus);
    KLBUI_GLOBAL_pic_bind("text-align:disable", globalcss_klbui_picture_text_align_disable);

    // 字体大小 font-size
    KLBUI_GLOBAL_pic_bind("font-size", globalcss_klbui_picture_font_size);
    KLBUI_GLOBAL_pic_bind("font-size:focus", globalcss_klbui_picture_font_size_focus);
    KLBUI_GLOBAL_pic_bind("font-size:disable", globalcss_klbui_picture_font_size_disable);

    // 背景色 background-color
    KLBUI_GLOBAL_pic_bind("background-color", globalcss_klbui_picture_background_color);
    KLBUI_GLOBAL_pic_bind("background-color:focus", globalcss_klbui_picture_background_color_focus);
    KLBUI_GLOBAL_pic_bind("background-color:disable", globalcss_klbui_picture_background_color_disable);

    // 背景图片 background-image
    KLBUI_GLOBAL_pic_bind("background-image", globalcss_klbui_picture_background_image);
    KLBUI_GLOBAL_pic_bind("background-image:focus", globalcss_klbui_picture_background_image_focus);
    KLBUI_GLOBAL_pic_bind("background-image:disable", globalcss_klbui_picture_background_image_disable);

    // 边框的宽度 border-width
    KLBUI_GLOBAL_pic_bind("border-width", globalcss_klbui_picture_border_width);
    KLBUI_GLOBAL_pic_bind("border-width:focus", globalcss_klbui_picture_border_width_focus);
    KLBUI_GLOBAL_pic_bind("border-width:disable", globalcss_klbui_picture_border_width_disable);

    // 边框的颜色 border-color
    KLBUI_GLOBAL_pic_bind("border-color", globalcss_klbui_picture_border_color);
    KLBUI_GLOBAL_pic_bind("border-color:focus", globalcss_klbui_picture_border_color_focus);
    KLBUI_GLOBAL_pic_bind("border-color:disable", globalcss_klbui_picture_border_color_disable);
}
...
{
    klbwnd_picture_css_t* p_css = check_css_klbui_picture(p_wnd, method);
...
{
	klbuicssex_attribute_sds(&(p_pic->picture.title), p_wnd, method, p_in, p_out);
}

static void on_klbui_picture_value(klb_wnd_t* p_wnd, klbui_picture_t* p_pic, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
	klbuicssex_attribute_sds(&(p_pic->picture.value), p_wnd, method, p_in, p_out);
}

static void on_klbui_picture_image(klb_wnd_t* p_wnd, klbui_picture_t* p_pic, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_attribute_sds(&(p_pic->picture.image), p_wnd, method, p_in, p_out);
}
...
static void klbui_picture_init_func_map(klb_wnd_t* p_wnd, klbui_picture_t* p_pic, klb_gui_t* p_gui)
{
	...
	// 文本颜色 color
	KLBUI_picture_bind("color", on_klbui_picture_text_color);
	KLBUI_picture_bind("color:focus", on_klbui_picture_text_color_focus);
	KLBUI_picture_bind("color:disable", on_klbui_picture_text_color_disable);

	// 文本对齐 text-align
	KLBUI_picture_bind("text-align", on_klbui_picture_text_align);
	KLBUI_picture_bind("text-align:focus", on_klbui_picture_text_align_focus);
	KLBUI_picture_bind("text-align:disable", on_klbui_picture_text_align_disable);

	// 字体大小 font-size
	KLBUI_picture_bind("font-size", on_klbui_picture_font_size);
	KLBUI_picture_bind("font-size:focus", on_klbui_picture_font_size_focus);
	KLBUI_picture_bind("font-size:disable", on_klbui_picture_font_size_disable);

	// 背景色 background-color
	KLBUI_picture_bind("background-color", on_klbui_picture_background_color);
	KLBUI_picture_bind("background-color:focus", on_klbui_picture_background_color_focus);
	KLBUI_picture_bind("background-color:disable", on_klbui_picture_background_color_disable);

	// 背景图片 background-image
	KLBUI_picture_bind("background-image", on_klbui_picture_background_image);
	KLBUI_picture_bind("background-image:focus", on_klbui_picture_background_image_focus);
	KLBUI_picture_bind("background-image:disable", on_klbui_picture_background_image_disable);

	// 边框的宽度 border-width
	KLBUI_picture_bind("border-width", on_klbui_picture_border_width);
	KLBUI_picture_bind("border-width:focus", on_klbui_picture_border_width_focus);
	KLBUI_picture_bind("border-width:disable", on_klbui_picture_border_width_disable);

	// 边框的颜色 border-color
	KLBUI_picture_bind("border-color", on_klbui_picture_border_color);
	KLBUI_picture_bind("border-color:focus", on_klbui_picture_border_color_focus);
	KLBUI_picture_bind("border-color:disable", on_klbui_picture_border_color_disable);
	...
	KLBUI_picture_bind("image", on_klbui_picture_image);
}

//////////////////////////////////////////////////////////////////////////
// create, register

static klb_wnd_t* klbui_picture_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    // step1. malloc
    ...
    // step4. 初始化CSS 支持的方法
	klbui_picture_init_func_map(p_wnd, p_pic, p_gui);

    // step5. 默认使用公用全局CSS属性
    p_pic->p_globalcss = (klbwnd_picture_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBUI_kpicture);
    klbwnd_picture_set_css(p_wnd, p_pic->p_globalcss);
...
{
    klbui_picture_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
    return klb_gui_register(p_gui, KLBUI_kpicture, klbui_picture_create);
}
