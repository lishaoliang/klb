...
static void on_klbui_spin_visibility(klb_wnd_t* p_wnd, klbui_spin_t* p_spin, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
...
static void klbui_spin_init_func_map(klb_wnd_t* p_wnd, klbui_spin_t* p_spin, klb_gui_t* p_gui)
{
    ...
    // 显隐
    KLBUI_spin_bind("visibility", on_klbui_spin_visibility); // 显示/隐藏
