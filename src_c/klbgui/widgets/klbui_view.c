...
static void klbui_view_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    klbwnd_view_css_quit(&p_view->css);
...
{
    klbuicssex_margin(&(p_view->css.margin), p_wnd, method, p_in, p_out);
}

static void on_klbui_view_margin_top(klb_wnd_t* p_wnd, klbui_view_t* p_view, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_margin_top(&(p_view->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_right(&(p_view->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_bottom(&(p_view->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_left(&(p_view->css.margin), p_wnd, method, p_in, p_out);
}

static void on_klbui_view_padding(klb_wnd_t* p_wnd, klbui_view_t* p_view, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_padding(&(p_view->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_top(&(p_view->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_right(&(p_view->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_bottom(&(p_view->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_left(&(p_view->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_view->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_view->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_view->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_view->css.normal.border), p_wnd, method, p_in, p_out);
}
...
static void klbui_view_init_func_map(klb_wnd_t* p_wnd, klbui_view_t* p_view, klb_gui_t* p_gui)
{
    ...
    p_view->p_func_map = ptr;
    klb_gui_css_map_append_std_function(ptr, p_view); // 添加公共方法
...
klb_wnd_t* klbui_view_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // css
    klbwnd_view_css_init(&p_view->css, p_gui);
    klbwnd_view_set_css(p_wnd, &p_view->css);
