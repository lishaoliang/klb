...
static int klbui_progress_on_command(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_progress_t* p_progress = (klbui_progress_t*)p_wnd->ctrl;
...
klb_wnd_t* klbui_progress_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_command = klbui_progress_on_command;
