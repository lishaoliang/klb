...
typedef struct klbui_progress_t_
{
    ...
    klbwnd_progress_css_t*  p_globalcss;    ///< 全局公共的CSS
    klbwnd_progress_css_t*  p_mycss;        ///< 私有的CSS
...
static void klbui_progress_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_progress_css_quit(p_prog->p_mycss);
...
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
    klbwnd_progress_css_quit(p_css);
    KLB_FREE(p_css);
}
...
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBUI_kprogress);
    if (NULL != ptr)
    {
        return;
    }
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_kprogress);

    // 添加全局 CSS 
    klbwnd_progress_css_t* p_css = KLB_MALLOCZ(klbwnd_progress_css_t, 1, 0);
    klbwnd_progress_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_kprogress, p_css, destroy_globalcss_klbwnd_progress);
    ...
    KLBUI_GLOBAL_progress_bind("color:disable", globalcss_klbui_progress_text_color_disable);
    ...
    KLBUI_GLOBAL_progress_bind("text-align:disable", globalcss_klbui_progress_text_align_disable);
    ...
    KLBUI_GLOBAL_progress_bind("font-size:disable", globalcss_klbui_progress_font_size_disable);
    ...
    KLBUI_GLOBAL_progress_bind("background-color:disable", globalcss_klbui_progress_background_color_disable);
    ...
    KLBUI_GLOBAL_progress_bind("background-image:disable", globalcss_klbui_progress_background_image_disable);
    ...
    KLBUI_GLOBAL_progress_bind("border-width:disable", globalcss_klbui_progress_border_width_disable);
    ...
    KLBUI_GLOBAL_progress_bind("border-color:disable", globalcss_klbui_progress_border_color_disable);
}
...
static klb_wnd_t* klbui_progress_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // step5. 默认使用公用全局CSS属性
    p_prog->p_globalcss = (klbwnd_progress_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBUI_kprogress);
...
{
    klbui_progress_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
    return klb_gui_register(p_gui, KLBUI_kprogress, klbui_progress_create);
}
