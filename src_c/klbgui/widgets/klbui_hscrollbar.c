...
/// @brief  horizontal scrollbar 水平滚动条
typedef struct klbui_hscrollbar_t_
{
    klbwnd_hscrollbar_t     hscrollbar;     ///< 必须首位, 保持内存一致
    klbwnd_hscrollbar_css_t css;            ///< 样式
...
static void klbui_hscrollbar_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    klbwnd_hscrollbar_css_quit(&p_hsc->css);
...
static void on_klbui_hscrollbar_visibility(klb_wnd_t* p_wnd, klbui_hscrollbar_t* p_hsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
...
{
    klbuicssex_margin(&(p_hsc->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_top(&(p_hsc->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_right(&(p_hsc->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_bottom(&(p_hsc->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_left(&(p_hsc->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding(&(p_hsc->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_top(&(p_hsc->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_right(&(p_hsc->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_bottom(&(p_hsc->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_left(&(p_hsc->css.padding), p_wnd, method, p_in, p_out);
}

static void on_klbui_hscrollbar_text_color(klb_wnd_t* p_wnd, klbui_hscrollbar_t* p_hsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_text_color(&(p_hsc->css.normal.text), p_wnd, method, p_in, p_out);
}

static void on_klbui_hscrollbar_text_color_focus(klb_wnd_t* p_wnd, klbui_hscrollbar_t* p_hsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_text_color(&(p_hsc->css.focus.text), p_wnd, method, p_in, p_out);
}

static void on_klbui_hscrollbar_text_color_disable(klb_wnd_t* p_wnd, klbui_hscrollbar_t* p_hsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_text_color(&(p_hsc->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_hsc->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_hsc->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_hsc->css.disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_hsc->css.normal.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_hsc->css.focus.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_hsc->css.disable.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_hsc->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_hsc->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_hsc->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_hsc->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_hsc->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_hsc->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_hsc->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_hsc->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_hsc->css.disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_hsc->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_hsc->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_hsc->css.disable.border), p_wnd, method, p_in, p_out);
}

//////////////////////////////////////
// 自定义属性

static void on_klbui_hscrollbar_title(klb_wnd_t* p_wnd, klbui_hscrollbar_t* p_hsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_attribute_sds(&(p_hsc->hscrollbar.title), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_attribute_sds(&(p_hsc->hscrollbar.value), p_wnd, method, p_in, p_out);
}

//////////////////////////////////////////////////////////////////////////
// css func

#define KLBUI_hscrollbar_bind(KEY_, FUNC_) { klb_map_set_ptr(p_hsc->p_func_map, (KEY_), (void*)(FUNC_), p_hsc); }

static void klbui_hscrollbar_init_func_map(klb_wnd_t* p_wnd, klbui_hscrollbar_t* p_hsc, klb_gui_t* p_gui)
{
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBUI_khscrollbar);
    if (NULL != ptr)
    {
    ...
    // 显隐
    KLBUI_hscrollbar_bind("visibility", on_klbui_hscrollbar_visibility); // 显示/隐藏
    ...
    // 文本颜色 color
    KLBUI_hscrollbar_bind("color", on_klbui_hscrollbar_text_color);
    KLBUI_hscrollbar_bind("color:focus", on_klbui_hscrollbar_text_color_focus);
    KLBUI_hscrollbar_bind("color:disable", on_klbui_hscrollbar_text_color_disable);
    ...
    KLBUI_hscrollbar_bind("text-align:disable", on_klbui_hscrollbar_text_align_disable);
    ...
    KLBUI_hscrollbar_bind("font-size:disable", on_klbui_hscrollbar_font_size_disable);
    ...
    KLBUI_hscrollbar_bind("background-color:disable", on_klbui_hscrollbar_background_color_disable);
    ...
    KLBUI_hscrollbar_bind("background-image:disable", on_klbui_hscrollbar_background_image_disable);
    ...
    KLBUI_hscrollbar_bind("border-width:disable", on_klbui_hscrollbar_border_width_disable);
    ...
    KLBUI_hscrollbar_bind("border-color:disable", on_klbui_hscrollbar_border_color_disable);

    //////////////////////////////////////////////
    // 自定义方法

    KLBUI_hscrollbar_bind("title", on_klbui_hscrollbar_title);
...
klb_wnd_t* klbui_hscrollbar_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // css
    klbwnd_hscrollbar_css_init(&p_hsc->css, p_gui);
    klbwnd_hscrollbar_set_css(p_wnd, &p_hsc->css);
