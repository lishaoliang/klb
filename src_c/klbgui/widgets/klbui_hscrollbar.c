...
typedef struct klbui_hscrollbar_t_
{
    ...
    klbwnd_hscrollbar_css_t*    p_globalcss;    ///< 全局公共的CSS
    klbwnd_hscrollbar_css_t*    p_mycss;        ///< 私有的CSS
...
static void klbui_hscrollbar_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_hscrollbar_css_quit(p_hsc->p_mycss);
...
static void globalcss_klbui_hscrollbar_text_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_hscrollbar_css_t* p_css = (klbwnd_hscrollbar_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_hscrollbar_text_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_hscrollbar_css_t* p_css = (klbwnd_hscrollbar_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_hscrollbar_text_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_hscrollbar_css_t* p_css = (klbwnd_hscrollbar_css_t*)ptr;
...
{
    klbwnd_hscrollbar_css_t* p_css = (klbwnd_hscrollbar_css_t*)ptr;
    klbwnd_hscrollbar_css_quit(p_css);
    KLB_FREE(p_css);
}
...
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBUI_khscrollbar);
    if (NULL != ptr)
    {
        return;
    }
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_khscrollbar);

    // 添加全局 CSS 
    klbwnd_hscrollbar_css_t* p_css = KLB_MALLOCZ(klbwnd_hscrollbar_css_t, 1, 0);
    klbwnd_hscrollbar_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_khscrollbar, p_css, destroy_globalcss_klbwnd_hscrollbar);
    ...
    // 文本颜色 color
    KLBUI_GLOBAL_hscrollbar_bind("color", globalcss_klbui_hscrollbar_text_color);
    KLBUI_GLOBAL_hscrollbar_bind("color:focus", globalcss_klbui_hscrollbar_text_color_focus);
    KLBUI_GLOBAL_hscrollbar_bind("color:disable", globalcss_klbui_hscrollbar_text_color_disable);
    ...
    KLBUI_GLOBAL_hscrollbar_bind("text-align:disable", globalcss_klbui_hscrollbar_text_align_disable);
    ...
    KLBUI_GLOBAL_hscrollbar_bind("font-size:disable", globalcss_klbui_hscrollbar_font_size_disable);
    ...
    KLBUI_GLOBAL_hscrollbar_bind("background-color:disable", globalcss_klbui_hscrollbar_background_color_disable);
    ...
    KLBUI_GLOBAL_hscrollbar_bind("background-image:disable", globalcss_klbui_hscrollbar_background_image_disable);
    ...
    KLBUI_GLOBAL_hscrollbar_bind("border-width:disable", globalcss_klbui_hscrollbar_border_width_disable);
    ...
    KLBUI_GLOBAL_hscrollbar_bind("border-color:disable", globalcss_klbui_hscrollbar_border_color_disable);
...
static klb_wnd_t* klbui_hscrollbar_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // step5. 默认使用公用全局CSS属性
    p_hsc->p_globalcss = (klbwnd_hscrollbar_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBUI_khscrollbar);
...
{
    klbui_hscrollbar_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
    return klb_gui_register(p_gui, KLBUI_khscrollbar, klbui_hscrollbar_create);
}
