...
typedef struct klbui_button_t_
{
    ...
    klbwnd_button_css_t*    p_globalcss;    ///< 全局公共的CSS
    klbwnd_button_css_t*    p_mycss;        ///< 私有的CSS
...
static void klbui_button_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_button_css_quit(p_btn->p_mycss);
...
static void klbui_button_init_globalcss(klb_gui_t* p_gui)
{
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_kbutton);

    // 添加全局 CSS 
    klbwnd_button_css_t* p_css = KLB_MALLOCZ(klbwnd_button_css_t, 1, 0);
    klbwnd_button_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_kbutton, p_css, destroy_globalcss_klbwnd_button);
    ...
    KLBUI_GLOBAL_btn_bind("color:disable", globalcss_klbui_button_text_color_disable);
    ...
    KLBUI_GLOBAL_btn_bind("text-align:disable", globalcss_klbui_button_text_align_disable);
    ...
    KLBUI_GLOBAL_btn_bind("font-size:disable", globalcss_klbui_button_font_size_disable);
    ...
    KLBUI_GLOBAL_btn_bind("background-color:disable", globalcss_klbui_button_background_color_disable);
    ...
    KLBUI_GLOBAL_btn_bind("background-image:disable", globalcss_klbui_button_background_image_disable);
    ...
    KLBUI_GLOBAL_btn_bind("border-width:disable", globalcss_klbui_button_border_width_disable);
    ...
    KLBUI_GLOBAL_btn_bind("border-color:disable", globalcss_klbui_button_border_color_disable);
...
{
    klbui_button_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
