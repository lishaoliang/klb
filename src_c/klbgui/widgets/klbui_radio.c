...
static void klbui_radio_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    klbwnd_radio_css_quit(&p_radio->css);
...
{
    klbuicssex_margin(&(p_radio->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_top(&(p_radio->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_right(&(p_radio->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_bottom(&(p_radio->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_left(&(p_radio->css.margin), p_wnd, method, p_in, p_out);
}

static void on_klbui_radio_padding(klb_wnd_t* p_wnd, klbui_radio_t* p_radio, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_padding(&(p_radio->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_top(&(p_radio->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_right(&(p_radio->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_bottom(&(p_radio->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_left(&(p_radio->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_radio->css.off_normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_radio->css.off_focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_radio->css.off_disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_radio->css.on_normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_radio->css.on_focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_radio->css.on_disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_radio->css.off_normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_radio->css.off_focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_radio->css.off_disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_radio->css.on_normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_radio->css.on_focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_radio->css.on_disable.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_radio->css.off_normal.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_radio->css.off_focus.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_radio->css.off_disable.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_radio->css.on_normal.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_radio->css.on_focus.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_radio->css.on_disable.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_radio->css.off_normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_radio->css.off_focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_radio->css.off_disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_radio->css.on_normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_radio->css.on_focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_radio->css.on_disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_radio->css.off_normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_radio->css.off_focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_radio->css.off_disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_radio->css.on_normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_radio->css.on_focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_radio->css.on_disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_radio->css.off_normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_radio->css.off_focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_radio->css.off_disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_radio->css.on_normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_radio->css.on_focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_radio->css.on_disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_radio->css.off_normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_radio->css.off_focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_radio->css.off_disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_radio->css.on_normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_radio->css.on_focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_radio->css.on_disable.border), p_wnd, method, p_in, p_out);
}
...
static void klbui_radio_init_func_map(klb_wnd_t* p_wnd, klbui_radio_t* p_radio, klb_gui_t* p_gui)
{
    ...
    p_radio->p_func_map = ptr;
    klb_gui_css_map_append_std_function(ptr, p_radio); // 添加公共方法
...
klb_wnd_t* klbui_radio_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // css
    klbwnd_radio_css_init(&p_radio->css, p_gui);
    klbwnd_radio_set_css(p_wnd, &p_radio->css);
