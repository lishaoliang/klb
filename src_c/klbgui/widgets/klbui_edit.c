...
static void klbui_edit_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出css
    klbwnd_edit_css_quit(&p_edit->css);
...
{
    klbuicssex_margin(&(p_edit->css.margin), p_wnd, method, p_in, p_out);
}

static void on_klbui_edit_margin_top(klb_wnd_t* p_wnd, klbui_edit_t* p_edit, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_margin_top(&(p_edit->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_right(&(p_edit->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_bottom(&(p_edit->css.margin), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_margin_left(&(p_edit->css.margin), p_wnd, method, p_in, p_out);
}

static void on_klbui_edit_padding(klb_wnd_t* p_wnd, klbui_edit_t* p_edit, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_padding(&(p_edit->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_top(&(p_edit->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_right(&(p_edit->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_bottom(&(p_edit->css.padding), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_padding_left(&(p_edit->css.padding), p_wnd, method, p_in, p_out);
}

static void on_klbui_edit_text_color(klb_wnd_t* p_wnd, klbui_edit_t* p_edit, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_text_color(&(p_edit->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_edit->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_color(&(p_edit->css.disable.text), p_wnd, method, p_in, p_out);
}

static void on_klbui_edit_text_align(klb_wnd_t* p_wnd, klbui_edit_t* p_edit, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_text_align(&(p_edit->css.normal.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_edit->css.focus.text), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_text_align(&(p_edit->css.disable.text), p_wnd, method, p_in, p_out);
}

static void on_klbui_edit_font_size(klb_wnd_t* p_wnd, klbui_edit_t* p_edit, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_font_size(&(p_edit->css.normal.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_edit->css.focus.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_font_size(&(p_edit->css.disable.font), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_edit->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_edit->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_color(&(p_edit->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_edit->css.normal.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_edit->css.focus.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_background_image(&(p_edit->css.disable.background), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_edit->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_edit->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_width(&(p_edit->css.disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_edit->css.normal.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_edit->css.focus.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_border_color(&(p_edit->css.disable.border), p_wnd, method, p_in, p_out);
}
...
{
    klbuicssex_attribute_sds(&(p_edit->edit.title), p_wnd, method, p_in, p_out);
}

static void on_klbui_edit_value(klb_wnd_t* p_wnd, klbui_edit_t* p_edit, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbuicssex_attribute_sds(&(p_edit->edit.value), p_wnd, method, p_in, p_out);
}
...
{
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBUI_kedit);
    if (NULL != ptr)
    {
    ...
    ptr = klb_gui_new_css_map(p_gui, KLBUI_kedit);
    p_edit->p_func_map = ptr;
    ...
    // 显隐
    KLBUI_edit_bind("visibility", on_klbui_edit_visibility); // 显示/隐藏
    ...
    KLBUI_edit_bind("color:disable", on_klbui_edit_text_color_disable);
    ...
    KLBUI_edit_bind("font-size:disable", on_klbui_edit_font_size_disable);
    ...
    KLBUI_edit_bind("background-color:disable", on_klbui_edit_background_color_disable);
    ...
    KLBUI_edit_bind("border-width:disable", on_klbui_edit_border_width_disable);
...
klb_wnd_t* klbui_edit_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // css
    klbwnd_edit_css_init(&p_edit->css, p_gui);
    klbwnd_edit_set_css(p_wnd, &p_edit->css);
