...
typedef struct klbui_rich_text_t_
{
    ...
    klbwnd_rich_text_css_t* p_globalcss;    ///< 全局公共的CSS
    klbwnd_rich_text_css_t* p_mycss;        ///< 私有的CSS
...
static void klbui_rich_text_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_rich_text_css_quit(p_rich->p_mycss);
...
// 新建私有CSS
static void new_my_css_klbui_rich_text(klb_wnd_t* p_wnd)
{
    klbui_rich_text_t* p_rich = (klbui_rich_text_t*)p_wnd->ctrl;

    if (NULL == p_rich->p_mycss)
    {
        p_rich->p_mycss = KLB_MALLOCZ(klbwnd_rich_text_css_t, 1, 0);

        // 从新建时, 复制公共参数; 后面分开
        klbwnd_rich_text_css_copy(p_rich->p_mycss, p_rich->p_globalcss);
        klbwnd_rich_text_set_css(p_wnd, p_rich->p_mycss);
    }
}

// 获取当前 CSS
static klbwnd_rich_text_css_t* get_css_klbui_rich_text(klb_wnd_t* p_wnd)
{
    klbui_rich_text_t* p_rich = (klbui_rich_text_t*)p_wnd->ctrl;
...
// 检查方法, 并获取当前的CSS
static klbwnd_rich_text_css_t* check_css_klbui_rich_text(klb_wnd_t* p_wnd, int method)
{
    if (KLBUI_CSSEX_set == method)
    {
        // 只要是 set-css 相关方法, 立即转换为使用私有CSS
        new_my_css_klbui_rich_text(p_wnd);
    }

    return get_css_klbui_rich_text(p_wnd);
}

//////////////////////////////////////////////////////////////////////////
// global CSS 方法 - 公共CSS属性

static void globalcss_klbui_rich_text_margin(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_margin(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_margin_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_margin_top(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_margin_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_margin_right(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_margin_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_margin_bottom(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_margin_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_margin_left(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_padding(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_padding(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_padding_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_padding_top(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_padding_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_padding_right(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_padding_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_padding_bottom(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_padding_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_padding_left(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_text_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_text_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_text_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_text_color(&(p_css->disable.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_text_align(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_text_align(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_text_align_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_text_align(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_text_align_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_text_align(&(p_css->disable.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_font_size(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_font_size(&(p_css->normal.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_font_size_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_font_size(&(p_css->focus.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_font_size_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_font_size(&(p_css->disable.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_background_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_background_color(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_background_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_background_color(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_background_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_background_color(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_background_image(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_background_image(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_background_image_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_background_image(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_background_image_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_background_image(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_border_width(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_border_width(&(p_css->normal.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_border_width_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_border_width(&(p_css->focus.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_border_width_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_border_width(&(p_css->disable.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_border_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_border_color(&(p_css->normal.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_border_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbuicssex_border_color(&(p_css->focus.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_rich_text_border_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
...
/// @brief 销毁 全局公共CSS属性
static void destroy_globalcss_klbwnd_rich_text(void* ptr)
{
    klbwnd_rich_text_css_t* p_css = (klbwnd_rich_text_css_t*)ptr;
    klbwnd_rich_text_css_quit(p_css);
    KLB_FREE(p_css);
}

#define KLBUI_GLOBAL_rich_text_bind(KEY_, FUNC_) { klb_map_set_ptr(ptr, (KEY_), (void*)(FUNC_), NULL); }

static void klbui_rich_text_init_globalcss(klb_gui_t* p_gui)
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBUI_krichtext);
    if (NULL != ptr)
    {
        return;
    }
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBUI_krichtext);

    // 添加全局 CSS 
    klbwnd_rich_text_css_t* p_css = KLB_MALLOCZ(klbwnd_rich_text_css_t, 1, 0);
    klbwnd_rich_text_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBUI_krichtext, p_css, destroy_globalcss_klbwnd_rich_text);
    ...
    // 外边距 margin
    KLBUI_GLOBAL_rich_text_bind("margin", globalcss_klbui_rich_text_margin);
    KLBUI_GLOBAL_rich_text_bind("margin-top", globalcss_klbui_rich_text_margin_top);
    KLBUI_GLOBAL_rich_text_bind("margin-right", globalcss_klbui_rich_text_margin_right);
    KLBUI_GLOBAL_rich_text_bind("margin-bottom", globalcss_klbui_rich_text_margin_bottom);
    KLBUI_GLOBAL_rich_text_bind("margin-left", globalcss_klbui_rich_text_margin_left);

    // 内边距 padding
    KLBUI_GLOBAL_rich_text_bind("padding", globalcss_klbui_rich_text_padding);
    KLBUI_GLOBAL_rich_text_bind("padding-top", globalcss_klbui_rich_text_padding_top);
    KLBUI_GLOBAL_rich_text_bind("padding-right", globalcss_klbui_rich_text_padding_right);
    KLBUI_GLOBAL_rich_text_bind("padding-bottom", globalcss_klbui_rich_text_padding_bottom);
    KLBUI_GLOBAL_rich_text_bind("padding-left", globalcss_klbui_rich_text_padding_left);

    // 文本颜色 color
    KLBUI_GLOBAL_rich_text_bind("color", globalcss_klbui_rich_text_text_color);
    KLBUI_GLOBAL_rich_text_bind("color:focus", globalcss_klbui_rich_text_text_color_focus);
    KLBUI_GLOBAL_rich_text_bind("color:disable", globalcss_klbui_rich_text_text_color_disable);

    // 文本对齐 text-align
    KLBUI_GLOBAL_rich_text_bind("text-align", globalcss_klbui_rich_text_text_align);
    KLBUI_GLOBAL_rich_text_bind("text-align:focus", globalcss_klbui_rich_text_text_align_focus);
    KLBUI_GLOBAL_rich_text_bind("text-align:disable", globalcss_klbui_rich_text_text_align_disable);

    // 字体大小 font-size
    KLBUI_GLOBAL_rich_text_bind("font-size", globalcss_klbui_rich_text_font_size);
    KLBUI_GLOBAL_rich_text_bind("font-size:focus", globalcss_klbui_rich_text_font_size_focus);
    KLBUI_GLOBAL_rich_text_bind("font-size:disable", globalcss_klbui_rich_text_font_size_disable);

    // 背景色 background-color
    KLBUI_GLOBAL_rich_text_bind("background-color", globalcss_klbui_rich_text_background_color);
    KLBUI_GLOBAL_rich_text_bind("background-color:focus", globalcss_klbui_rich_text_background_color_focus);
    KLBUI_GLOBAL_rich_text_bind("background-color:disable", globalcss_klbui_rich_text_background_color_disable);

    // 背景图片 background-image
    KLBUI_GLOBAL_rich_text_bind("background-image", globalcss_klbui_rich_text_background_image);
    KLBUI_GLOBAL_rich_text_bind("background-image:focus", globalcss_klbui_rich_text_background_image_focus);
    KLBUI_GLOBAL_rich_text_bind("background-image:disable", globalcss_klbui_rich_text_background_image_disable);

    // 边框的宽度 border-width
    KLBUI_GLOBAL_rich_text_bind("border-width", globalcss_klbui_rich_text_border_width);
    KLBUI_GLOBAL_rich_text_bind("border-width:focus", globalcss_klbui_rich_text_border_width_focus);
    KLBUI_GLOBAL_rich_text_bind("border-width:disable", globalcss_klbui_rich_text_border_width_disable);

    // 边框的颜色 border-color
    KLBUI_GLOBAL_rich_text_bind("border-color", globalcss_klbui_rich_text_border_color);
    KLBUI_GLOBAL_rich_text_bind("border-color:focus", globalcss_klbui_rich_text_border_color_focus);
    KLBUI_GLOBAL_rich_text_bind("border-color:disable", globalcss_klbui_rich_text_border_color_disable);
...
{
    klbwnd_rich_text_css_t* p_css = check_css_klbui_rich_text(p_wnd, method);
...
static void on_klbui_rich_text_index(klb_wnd_t* p_wnd, klbui_rich_text_t* p_rich, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    //klbuicssex_attribute_int(&(p_rich->rich_text.index), p_wnd, method, p_in, p_out);
}
...
#define KLBUI_rich_text_bind(KEY_, FUNC_) { klb_map_set_ptr(p_rich->p_func_map, (KEY_), (void*)(FUNC_), NULL); }
...
static void klbui_rich_text_init_func_map(klb_wnd_t* p_wnd, klbui_rich_text_t* p_rich, klb_gui_t* p_gui)
{
    ...
    KLBUI_rich_text_bind("index", on_klbui_rich_text_index);
...
static klb_wnd_t* klbui_rich_text_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    // step1. malloc
    ...
    // step5. 默认使用公用全局CSS属性
    p_rich->p_globalcss = (klbwnd_rich_text_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBUI_krichtext);
    klbwnd_rich_text_set_css(p_wnd, p_rich->p_globalcss);
...
{
    klbui_rich_text_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
    return klb_gui_register(p_gui, KLBUI_krichtext, klbui_rich_text_create);
}
