...
static int klbui_rich_text_on_paint(klb_wnd_t* p_wnd)
{
    klbui_rich_text_t* p_rich = (klbui_rich_text_t*)p_wnd->ctrl;
...
static int klbui_rich_text_on_control(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_rich_text_t* p_rich = (klbui_rich_text_t*)p_wnd->ctrl;
    ...
    {
    case KLBUI_PAINT:
        return klbui_rich_text_on_paint(p_wnd);
    default:
        break;
    }
...
static int klbui_rich_text_on_command(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_rich_text_t* p_rich = (klbui_rich_text_t*)p_wnd->ctrl;
...
klb_wnd_t* klbui_rich_text_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_control = klbui_rich_text_on_control;
    p_wnd->vtable.on_command = klbui_rich_text_on_command;
