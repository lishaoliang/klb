...
static int klbui_tab_on_command(klb_wnd_t* p_wnd, int msg, const klb_point_t* p_pt1, const klb_point_t* p_pt2, int lparam, int wparam)
{
    klbui_tab_t* p_tab = (klbui_tab_t*)p_wnd->ctrl;
...
klb_wnd_t* klbui_tab_create(int x, int y, int w, int h)
{
    ...
    p_wnd->vtable.on_command = klbui_tab_on_command;
