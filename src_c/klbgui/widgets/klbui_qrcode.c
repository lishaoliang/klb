...
static void on_klbui_qrcode_tip(klb_wnd_t* p_wnd, klbui_qrcode_t* p_qrcode, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
...
static void on_klbui_qrcode_visibility(klb_wnd_t* p_wnd, klbui_qrcode_t* p_qrcode, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
...
static void klbui_qrcode_init_func_map(klb_wnd_t* p_wnd, klbui_qrcode_t* p_qrcode, klb_gui_t* p_gui)
{
    ...
    // tip
    KLBUI_qrcode_bind("tip", on_klbui_qrcode_tip);

    // 显隐
    KLBUI_qrcode_bind("visibility", on_klbui_qrcode_visibility); // 显示/隐藏
