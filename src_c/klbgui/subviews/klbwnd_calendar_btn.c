...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_calendar_btn_quit_attribute(klbwnd_calendar_btn_t* p_btn);
...
static void klbwnd_calendar_btn_destroy(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_calendar_btn_quit(p_wnd);
...
static void klbwnd_calendar_btn_on_paint_status_normal(klb_wnd_t* p_wnd, klbwnd_calendar_btn_t* p_btn, klbwnd_calendar_btn_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
static void klbwnd_calendar_btn_on_paint_status_prev(klb_wnd_t* p_wnd, klbwnd_calendar_btn_t* p_btn, klbwnd_calendar_btn_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
    if (0 < sdslen(p_attr->background.image))
    {
        // 图片背景
...
static void klbwnd_calendar_btn_on_paint_status_next(klb_wnd_t* p_wnd, klbwnd_calendar_btn_t* p_btn, klbwnd_calendar_btn_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
    if (0 < sdslen(p_attr->background.image))
    {
        // 图片背景
...
static void klbwnd_calendar_btn_on_paint_status(klb_wnd_t* p_wnd, klbwnd_calendar_btn_t* p_btn, klbwnd_calendar_btn_css_t* p_css, klbuicssex_attributes_t* p_attr, klb_rect_t* p_rect)
{
    switch (p_btn->type)
    {
...
void klbwnd_calendar_btn_quit(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_calendar_btn_quit_attribute(p_btn);
}
