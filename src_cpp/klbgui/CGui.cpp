...
int CGui::Model(const char* p_path_name)
{
    return klb_gui_model(m_gui, p_path_name);
}

int CGui::Model(const std::string& path_name)
{
    return klb_gui_model(m_gui, path_name.c_str());
}

int CGui::ModelWnd(klb_wnd_t* p_top)
{
    return klb_gui_model_wnd(m_gui, p_top);
}

int CGui::ModelWnd(CWnd* p_top)
{
    return klb_gui_model_wnd(m_gui, p_top->GetWnd());
}

int CGui::ModelEnd(bool all, const char* p_path_name)
{
    return klb_gui_model_end(m_gui, all, p_path_name);
}

int CGui::ModelEnd(bool all, const std::string& path_name)
{
    return klb_gui_model_end(m_gui, all, path_name.c_str());
}
...
bool CGui::CheckColor(const klb_map_t* p_map, int start, uint32_t* p_out_color)
{
...
/// @brief 设置CSS默认值(全局值)
int CGui::DefaultCssSet(const klb_map_t* p_map)
{
    return klb_gui_default_css_set(m_gui, p_map);
}

/// @brief 获取CSS默认值(全局值)
klb_map_t* CGui::DefaultCssGet(const klb_map_t* p_map)
{
...
int CGui::ShWndCssSet(const char* p_path, const klb_map_t* p_map)
{
    return klb_gui_shwnd_css_set(m_gui, p_path, p_map);
}

int CGui::ShWndCssSet(const std::string& path, const klb_map_t* p_map)
{
    return klb_gui_shwnd_css_set(m_gui, path.c_str(), p_map);
}

klb_map_t* CGui::ShWndCssGet(const char* p_path, const klb_map_t* p_map)
{
    return klb_gui_shwnd_css_get(m_gui, p_path, p_map);
}

klb_map_t* CGui::ShWndCssGet(const std::string& path, const klb_map_t* p_map)
{
