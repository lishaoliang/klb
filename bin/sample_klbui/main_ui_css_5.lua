...
-- step1. 打开窗口
wsdl.open_wnd(basepath .. 'res/font/simsun.ttc', CONST_w,  CONST_h, 'klbui-css示例5' )
...
home.css = {
	['type'] = {	
		...
		['kcombo'] = {
			...
			['button_right.color'] = {255, 120, 120, 120},
			['button_right.color:focus'] = {255, 20, 20, 250},
		},
	},
...
local view1 = {
	--['path'] = '/home/view1',
	['type'] = 'kview',
	['pos'] = {0, 32, CONST_w, CONST_h - 32},
	['title'] = '页面1',
	['name'] = 'view1',
	
	['child'] = {
		{
			['path'] = '/home/view1/btn1',
			['type'] = 'kbutton',
			['pos'] = {10, 64 + 10, 140, 32},
			['title'] = '按钮111',
			['name'] = 'btn1',
...
local view2 = {
	...
	['child'] = {
		...
		
		{
			...
			['menu.border-color'] = {255, 220, 220, 220},
			--['menu.border-width'] = {1, 1, 1, 1},
			--['menu.padding-left'] = 4,
			--['menu.padding-right'] = 4,
			
			['append'] = {
				{['1'] = 'AAAA1'},
				{['2'] = 'BBB2'},
				{['3'] = 'CCCC3111111111111111'},
				{['10'] = 'DDD10'},
				{['11'] = 'EEE11'},
			}
		},
...
home.dialog = {
	...
	['title'] = 'klbui-css示例5 - hello world!',
	['name'] = 'home1',
...
home.commonds = {
	['/home'] = {
		['onload'] = function ()
			jq('btn22').click(function ()
				print(jq('combo23').value(), jq('combo23').title())			
			end)
		end,
