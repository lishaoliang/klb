...
lsm_ws.on_newconn = function (name, protocol, ok, err)
	print('lsm_ws.on_newconn', name, protocol, ok, err)
	return 0
end

lsm_ws.on_receiver = function (name, protocol, sequence, uid, head, body)
	--print('lsm_ws.on_receiver', name, protocol, sequence, uid, head, body)
	...
	if '' ~= req.method then
		...
		--print('lsm_ws.send_txt', res_head)
...
lsm_ws.on_disconnect = function (name, protocol, err)
	print('lsm_ws.on_disconnect', name, protocol, err)
