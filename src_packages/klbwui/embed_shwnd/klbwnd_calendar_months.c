...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_calendar_months_deinit_attribute(klbwnd_calendar_months_t* p_months);
...
static void klbwnd_calendar_months_destroy(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_calendar_months_deinit(p_wnd);
...
void klbwnd_calendar_months_deinit(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_calendar_months_deinit_attribute(p_months);
}
