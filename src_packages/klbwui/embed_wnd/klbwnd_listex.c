...
#include "klbwui/embed_wnd/klbwnd_listex_row.h"
...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_listex_deinit_attribute(klbwnd_listex_t* p_list);
...
static void klbwnd_listex_on_paint_status_head(klb_wnd_t* p_wnd, klbwnd_listex_t* p_list, klbwnd_listex_css_t* p_css, klbwnd_listex_attributes_t* p_attr, klb_rect_t* p_rect)
{
    // 绘制题头
...
static void klbwnd_listex_on_paint_status_body(klb_wnd_t* p_wnd, klbwnd_listex_t* p_list, klbwnd_listex_css_t* p_css, klbwnd_listex_attributes_t* p_attr)
{
    /* eg.
    jq('listex1').append({
...
static void klbwnd_listex_on_paint_status(klb_wnd_t* p_wnd, klbwnd_listex_t* p_list, klbwnd_listex_css_t* p_css, klbwnd_listex_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
int klbwnd_listex_append_column(klb_wnd_t* p_wnd, int w_column, const char* p_title, const klb_map_t* p_child)
{
    ...
    p_list->head.column[idx].title = klb_sds_assign(p_list->head.column[idx].title, p_title);
...
static void klbwnd_listex_attributes_init(klbwnd_listex_attributes_t* p_attr, const klbuicssex_attributes_t* p_src)
{
...
static void klbwnd_listex_attributes_deinit(klbwnd_listex_attributes_t* p_attr)
{
    KLB_FREE_BY(p_attr->background.image, sdsfree);
}

static void klbwnd_listex_attributes_copy(klbwnd_listex_attributes_t* p_dst, const klbwnd_listex_attributes_t* p_src)
{
...
void klbwnd_listex_css_init(klbwnd_listex_css_t* p_css, klb_gui_t* p_gui)
{
    ...
    klbwnd_listex_attributes_init(&p_css->normal, &p_default->normal);
    klbwnd_listex_attributes_init(&p_css->focus, &p_default->focus);
    klbwnd_listex_attributes_init(&p_css->disable, &p_default->disable);
...
{
    klbwnd_listex_attributes_deinit(&p_css->normal);
    klbwnd_listex_attributes_deinit(&p_css->focus);
    klbwnd_listex_attributes_deinit(&p_css->disable);

    // 行控件 CSS
    klbwnd_listex_row_css_deinit(&p_css->css_listex_row);

    // check
    klbwnd_check_css_deinit(&p_css->css_check);

    // 垂直滚动条
    klbwnd_vscrollbar_css_deinit(&p_css->css_vscrollbar);
}
...
void klbwnd_listex_css_copy(klbwnd_listex_css_t* p_dst, klbwnd_listex_css_t* p_src)
{
    ...
    klbwnd_listex_attributes_copy(&p_dst->normal, &p_src->normal);
    klbwnd_listex_attributes_copy(&p_dst->focus, &p_src->focus);
    klbwnd_listex_attributes_copy(&p_dst->disable, &p_src->disable);
...
void klbwnd_listex_deinit(klb_wnd_t* p_wnd)
{
    ...
    klb_map_clear(&p_list->data_map);
    klbwnd_listex_deinit_attribute(p_list);
}
