...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_list_deinit_attribute(klbwnd_list_t* p_list);
...
static void klbwnd_list_on_paint_status_head(klb_wnd_t* p_wnd, klbwnd_list_t* p_list, klbwnd_list_css_t* p_css, klbwnd_list_attributes_t* p_attr, klb_rect_t* p_rect)
{
    // 绘制题头
...
static void klbwnd_list_on_paint_status_body(klb_wnd_t* p_wnd, klbwnd_list_t* p_list, klbwnd_list_css_t* p_css, klbwnd_list_attributes_t* p_attr)
{
    /* eg.
        jq('list1').append({
...
static void klbwnd_list_on_paint_status(klb_wnd_t* p_wnd, klbwnd_list_t* p_list, klbwnd_list_css_t* p_css, klbwnd_list_attributes_t* p_attr, klb_rect_t* p_rect)
{
...
static void klbwnd_list_attributes_init(klbwnd_list_attributes_t* p_attr, const klbuicssex_attributes_t* p_src)
{
...
static void klbwnd_list_attributes_deinit(klbwnd_list_attributes_t* p_attr)
{
    KLB_FREE_BY(p_attr->background.image, sdsfree);
}

static void klbwnd_list_attributes_copy(klbwnd_list_attributes_t* p_dst, const klbwnd_list_attributes_t* p_src)
{
...
void klbwnd_list_css_init(klbwnd_list_css_t* p_css, klb_gui_t* p_gui)
{
    ...
    klbwnd_list_attributes_init(&p_css->normal, &p_default->normal);
    klbwnd_list_attributes_init(&p_css->focus, &p_default->focus);
    klbwnd_list_attributes_init(&p_css->disable, &p_default->disable);
...
{
    klbwnd_list_attributes_deinit(&p_css->normal);
    klbwnd_list_attributes_deinit(&p_css->focus);
    klbwnd_list_attributes_deinit(&p_css->disable);

    // 行控件 CSS
    klbwnd_list_row_css_deinit(&p_css->css_list_row);
...
void klbwnd_list_css_copy(klbwnd_list_css_t* p_dst, klbwnd_list_css_t* p_src)
{
    ...
    klbwnd_list_attributes_copy(&p_dst->normal, &p_src->normal);
    klbwnd_list_attributes_copy(&p_dst->focus, &p_src->focus);
    klbwnd_list_attributes_copy(&p_dst->disable, &p_src->disable);
...
void klbwnd_list_deinit(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_list_deinit_attribute(p_list);
}
