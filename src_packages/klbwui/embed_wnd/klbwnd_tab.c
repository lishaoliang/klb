...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_tab_deinit_attribute(klbwnd_tab_t* p_tab);
...
static void klbwnd_tab_on_paint_status(klb_wnd_t* p_wnd, klbwnd_tab_t* p_tab, klbwnd_tab_css_t* p_css, klbwnd_tab_attributes_t* p_attr, klb_rect_t* p_rect)
{
    // 纯色背景
...
void klbwnd_tab_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_tab->title = klb_sds_assign(p_tab->title, p_title);
}
...
void klbwnd_tab_set_value(klb_wnd_t* p_wnd, const char* p_value)
{
    ...
    p_tab->value = klb_sds_assign(p_tab->value, p_value);
}
...
static void klbwnd_tab_attributes_init(klbwnd_tab_attributes_t* p_attr, const klbuicssex_attributes_t* p_src)
{
...
static void klbwnd_tab_attributes_deinit(klbwnd_tab_attributes_t* p_attr)
{
    KLB_FREE_BY(p_attr->background.image, sdsfree);
}

static void klbwnd_tab_attributes_copy(klbwnd_tab_attributes_t* p_dst, const klbwnd_tab_attributes_t* p_src)
{
...
void klbwnd_tab_css_init(klbwnd_tab_css_t* p_css, klb_gui_t* p_gui)
{
    ...
    klbwnd_tab_attributes_init(&p_css->normal, &p_default->normal);
...
{
    klbwnd_tab_attributes_deinit(&p_css->normal);
    klbwnd_tab_btn_css_deinit(&p_css->btn_css);
}
...
void klbwnd_tab_css_copy(klbwnd_tab_css_t* p_dst, klbwnd_tab_css_t* p_src)
{
    ...
    klbwnd_tab_attributes_copy(&p_dst->normal, &p_src->normal);
...
void klbwnd_tab_deinit(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_tab_deinit_attribute(p_tab);
}
