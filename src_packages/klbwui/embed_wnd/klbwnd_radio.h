...
typedef struct klbwnd_radio_attributes_t_
{
...
typedef struct klbwnd_radio_css_t_
{
    ...
    klbwnd_radio_attributes_t   normal;         ///< normal 常规状态参数
    klbwnd_radio_attributes_t   focus;          ///< focus 聚焦状态参数
    klbwnd_radio_attributes_t   disable;        ///< disable 不使能状态参数

    klbwnd_radio_attributes_t   check_normal;   ///< check 选中常规状态参数
    klbwnd_radio_attributes_t   check_focus;    ///< check 选中聚焦状态参数
    klbwnd_radio_attributes_t   check_disable;  ///< check 选中不使能状态参数
} klbwnd_radio_css_t;
