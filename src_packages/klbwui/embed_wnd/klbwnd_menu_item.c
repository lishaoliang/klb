...
//////////////////////////////////////////////////////////////////////////
// 前置定义
static void klbwnd_menu_item_deinit_attribute(klbwnd_menu_item_t* p_item);
...
static void klbwnd_menu_item_destroy(klb_wnd_t* p_wnd)
{
    ...
    klbwnd_menu_item_deinit(p_wnd);

    KLB_FREE(p_wnd);
}

static void klbwnd_menu_item_on_paint_status(klb_wnd_t* p_wnd, klbwnd_menu_item_t* p_item, klbwnd_menu_item_css_t* p_css, klbwnd_menu_item_attributes_t* p_attr, klb_rect_t* p_rect)
{
    // 纯色背景
...
void klbwnd_menu_item_set_title(klb_wnd_t* p_wnd, const char* p_title)
{
    ...
    p_item->title = klb_sds_assign(p_item->title, p_title);
}
...
void klbwnd_menu_item_set_value(klb_wnd_t* p_wnd, const char* p_value)
{
    ...
    p_item->value = klb_sds_assign(p_item->value, p_value);
}
...
static void klbwnd_menu_item_attributes_init(klbwnd_menu_item_attributes_t* p_attr, const klbuicssex_attributes_t* p_src)
{
...
static void klbwnd_menu_item_attributes_deinit(klbwnd_menu_item_attributes_t* p_attr)
{
    KLB_FREE_BY(p_attr->background.image, sdsfree);
}

static void klbwnd_menu_item_attributes_copy(klbwnd_menu_item_attributes_t* p_dst, const klbwnd_menu_item_attributes_t* p_src)
{
...
void klbwnd_menu_item_css_init(klbwnd_menu_item_css_t* p_css, klb_gui_t* p_gui)
{
    ...
    klbwnd_menu_item_attributes_init(&p_css->normal, &p_default->normal);
    klbwnd_menu_item_attributes_init(&p_css->focus, &p_default->focus);
    klbwnd_menu_item_attributes_init(&p_css->disable, &p_default->disable);
...
void klbwnd_menu_item_css_deinit(klbwnd_menu_item_css_t* p_css)
{
    klbwnd_menu_item_attributes_deinit(&p_css->normal);
    klbwnd_menu_item_attributes_deinit(&p_css->focus);
    klbwnd_menu_item_attributes_deinit(&p_css->disable);
}
...
void klbwnd_menu_item_css_copy(klbwnd_menu_item_css_t* p_dst, klbwnd_menu_item_css_t* p_src)
{
    ...
    klbwnd_menu_item_attributes_copy(&p_dst->normal, &p_src->normal);
    klbwnd_menu_item_attributes_copy(&p_dst->focus, &p_src->focus);
    klbwnd_menu_item_attributes_copy(&p_dst->disable, &p_src->disable);
}
...
void klbwnd_menu_item_deinit(klb_wnd_t* p_wnd)
{
    klbwnd_menu_item_t* p_item = (klbwnd_menu_item_t*)p_wnd->ctrl;

    klbwnd_menu_item_deinit_attribute(p_item);
}
