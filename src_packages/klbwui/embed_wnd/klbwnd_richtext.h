...
//
/// @file    klbwnd_richtext.h
/// @author  随风(https://gitee.com/klua/klb)
/// @brief   klb window richtext, 富文本
/// @version 0.1
/// @history 修改历史
///   \n 2026 0.1 创建文件
/// @warning 没有警告
///////////////////////////////////////////////////////////////////////////
#ifndef __KLBWND_RICHTEXT_H__
#define __KLBWND_RICHTEXT_H__
...
typedef struct klbwnd_richtext_attributes_t_
{
...
} klbwnd_richtext_attributes_t;


typedef struct klbwnd_richtext_css_t_
{
    klbuicss_margin_t               margin;         ///< 外边距
    klbuicss_padding_t              padding;        ///< 内边距

    klbwnd_richtext_attributes_t    normal;         ///< normal 常规状态参数
    klbwnd_richtext_attributes_t    focus;          ///< focus 聚焦状态参数
    klbwnd_richtext_attributes_t    disable;        ///< disable 不使能状态参数
} klbwnd_richtext_css_t;


typedef struct klbwnd_richtext_t_
{
    klbwnd_richtext_css_t*          p_css;          ///< 样式
