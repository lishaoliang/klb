...
#include "klbwui/embed_wnd/klbwnd_listex.h"
...
static void klbui_listex_destroy(klb_wnd_t* p_wnd)
{
    ...
    // 退出基础部分
    klbwnd_listex_deinit(p_wnd);

    // 退出css
    if (NULL != p_list->p_mycss)
    {
        klbwnd_listex_css_deinit(p_list->p_mycss);
...
{
    klbwnd_listex_css_t* p_css = (klbwnd_listex_css_t*)ptr;
    klbwnd_listex_css_deinit(p_css);
    KLB_FREE(p_css);
}
...
static void klbui_listex_init_globalcss(klb_gui_t* p_gui)
{
    ...
    KLBUI_GLOBAL_listex_bind("color:disabled", globalcss_klbui_listex_text_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("text-align:disabled", globalcss_klbui_listex_text_align_disable);
    ...
    KLBUI_GLOBAL_listex_bind("font-size:disabled", globalcss_klbui_listex_font_size_disable);
    ...
    KLBUI_GLOBAL_listex_bind("background-color:disabled", globalcss_klbui_listex_background_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("background-image:disabled", globalcss_klbui_listex_background_image_disable);
    ...
    KLBUI_GLOBAL_listex_bind("border-width:disabled", globalcss_klbui_listex_border_width_disable);
    ...
    KLBUI_GLOBAL_listex_bind("border-color:disabled", globalcss_klbui_listex_border_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("row.color:disabled", globalcss_klbui_listex_row_text_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("row.text-align:disabled", globalcss_klbui_listex_row_text_align_disable);
    ...
    KLBUI_GLOBAL_listex_bind("row.font-size:disabled", globalcss_klbui_listex_row_font_size_disable);
    ...
    KLBUI_GLOBAL_listex_bind("row1.background-color:disabled", globalcss_klbui_listex_row1_background_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("row2.background-color:disabled", globalcss_klbui_listex_row2_background_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("vscrollbar.background-color:disabled", globalcss_klbui_listex_vscrollbar_background_color_disable);
    ...
    KLBUI_GLOBAL_listex_bind("vscrollbar.border-width:disabled", globalcss_klbui_listex_vscrollbar_border_width_disable);
    ...
    KLBUI_GLOBAL_listex_bind("vscrollbar.border-color:disabled", globalcss_klbui_listex_vscrollbar_border_color_disable);
...
static void klbui_listex_init_func_map(klb_wnd_t* p_wnd, klbui_listex_t* p_list, klb_gui_t* p_gui)
{
    ...
    KLBUI_listex_bind("color:disabled", on_klbui_listex_text_color_disable);
    ...
    KLBUI_listex_bind("text-align:disabled", on_klbui_listex_text_align_disable);

    // 字体大小 font-size
    KLBUI_listex_bind("font-size", on_klbui_listex_font_size);
    KLBUI_listex_bind("font-size:focus", on_klbui_listex_font_size_focus);
    KLBUI_listex_bind("font-size:disabled", on_klbui_listex_font_size_disable);
    ...
    KLBUI_listex_bind("background-color:disabled", on_klbui_listex_background_color_disable);
    ...
    KLBUI_listex_bind("background-image:disabled", on_klbui_listex_background_image_disable);
    ...
    KLBUI_listex_bind("border-width:disabled", on_klbui_listex_border_width_disable);
    ...
    KLBUI_listex_bind("border-color:disabled", on_klbui_listex_border_color_disable);
    ...
    KLBUI_listex_bind("row.color:disabled", on_klbui_listex_row_text_color_disable);
    ...
    KLBUI_listex_bind("row.text-align:disabled", on_klbui_listex_row_text_align_disable);
    ...
    KLBUI_listex_bind("row.font-size:disabled", on_klbui_listex_row_font_size_disable);
    ...
    KLBUI_listex_bind("row1.background-color:disabled", on_klbui_listex_row1_background_color_disable);
    ...
    KLBUI_listex_bind("row2.background-color:disabled", on_klbui_listex_row2_background_color_disable);
    ...
    KLBUI_listex_bind("vscrollbar.background-color:disabled", on_klbui_listex_vscrollbar_background_color_disable);
    ...
    KLBUI_listex_bind("vscrollbar.border-width:disabled", on_klbui_listex_vscrollbar_border_width_disable);
    ...
    KLBUI_listex_bind("vscrollbar.border-color:disabled", on_klbui_listex_vscrollbar_border_color_disable);
...
static klb_wnd_t* klbui_listex_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // step5. 默认使用公用全局CSS属性
    p_list->p_globalcss = (klbwnd_listex_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBWUI_klistex);
...
{
    klbui_listex_init_globalcss(p_gui); // 初始化全局CSS, 需要注册时初始化, 否则全局属性无法生效
    return klb_gui_register(p_gui, KLBWUI_klistex, klbui_listex_create);
}
