...
/// @struct klbui_ip_t
/// @brief  点分 IP 编辑框: Lua 注册名 kip
typedef struct klbui_ip_t_
{
    klbwnd_ip_t            ip;          ///< 必须首位, 保持内存一致

    klbwnd_ip_css_t*       p_globalcss;    ///< 全局公共的 CSS
    klbwnd_ip_css_t*       p_mycss;        ///< 私有的 CSS
...
static void klbui_ip_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_ip_css_deinit(p_ip->p_mycss);
...
static void globalcss_klbui_ip_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
...
static void globalcss_klbui_ip_background_image_mode(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_background_image_mode_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_background_image_mode_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_background_image_color_key(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_background_image_color_key_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_ip_background_image_color_key_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = (klbwnd_ip_css_t*)ptr;
...
static void destroy_globalcss_klbwnd_ip(void* ptr)
{
    ...
    klbwnd_ip_css_deinit(p_css);
    KLB_FREE(p_css);
}

#define KLBUI_GLOBAL_ip_bind(KEY_, FUNC_) { klb_map_set_ptr(ptr, (KEY_), (void*)(FUNC_), NULL); }

static void klbui_ip_init_globalcss(klb_gui_t* p_gui)
{
    // step1. 获取CSS 支持的方法
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBWUI_kip);
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBWUI_kip);

    klbwnd_ip_css_t* p_css = KLB_MALLOCZ(klbwnd_ip_css_t, 1, 0);
    klbwnd_ip_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBWUI_kip, p_css, destroy_globalcss_klbwnd_ip);
    ...
    // 文本颜色 color
    KLBUI_GLOBAL_ip_bind("color", globalcss_klbui_ip_color);
    KLBUI_GLOBAL_ip_bind("color:focus", globalcss_klbui_ip_color_focus);
    KLBUI_GLOBAL_ip_bind("color:disabled", globalcss_klbui_ip_color_disable);
    ...
    KLBUI_GLOBAL_ip_bind("text-align:disabled", globalcss_klbui_ip_text_align_disable);
    ...
    KLBUI_GLOBAL_ip_bind("font-size:disabled", globalcss_klbui_ip_font_size_disable);
    ...
    KLBUI_GLOBAL_ip_bind("background-color:disabled", globalcss_klbui_ip_background_color_disable);
    ...
    KLBUI_GLOBAL_ip_bind("background-image:disabled", globalcss_klbui_ip_background_image_disable);

    KLBUI_GLOBAL_ip_bind("background-image-mode", globalcss_klbui_ip_background_image_mode);
    KLBUI_GLOBAL_ip_bind("background-image-mode:focus", globalcss_klbui_ip_background_image_mode_focus);
    KLBUI_GLOBAL_ip_bind("background-image-mode:disabled", globalcss_klbui_ip_background_image_mode_disable);

    KLBUI_GLOBAL_ip_bind("background-image-color-key", globalcss_klbui_ip_background_image_color_key);
    KLBUI_GLOBAL_ip_bind("background-image-color-key:focus", globalcss_klbui_ip_background_image_color_key_focus);
    KLBUI_GLOBAL_ip_bind("background-image-color-key:disabled", globalcss_klbui_ip_background_image_color_key_disable);
    ...
    KLBUI_GLOBAL_ip_bind("border-width:disabled", globalcss_klbui_ip_border_width_disable);
    ...
    KLBUI_GLOBAL_ip_bind("border-color:disabled", globalcss_klbui_ip_border_color_disable);
...
static void on_klbui_ip_color(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_color_focus(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_color_disable(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_background_image_mode(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_background_image_mode_focus(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_background_image_mode_disable(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_background_image_color_key(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_background_image_color_key_focus(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_background_image_color_key_disable(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_ip_css_t* p_css = check_css_klbui_ip(p_wnd, method);
...
static void on_klbui_ip_value(klb_wnd_t* p_wnd, klbui_ip_t* p_ip, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    ...
    {
        const sds value = klbwnd_ip_get_value(p_wnd);
    ...
    else if (KLBUI_CSSEX_set == method)
    {
        ...
        klbwnd_ip_set_value(p_wnd, p_value);
...
{
    // step1. 获取CSS 支持的方法
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBWUI_kip);
    if (NULL != ptr)
    {
        p_ip->p_func_map = ptr;
        return;
    ...
    ptr = klb_gui_new_css_map(p_gui, KLBWUI_kip);
    p_ip->p_func_map = ptr;
    ...
    // 文本颜色 color
    KLBUI_ip_bind("color", on_klbui_ip_color);
    KLBUI_ip_bind("color:focus", on_klbui_ip_color_focus);
    KLBUI_ip_bind("color:disabled", on_klbui_ip_color_disable);

    // 文本对齐 text-align
    KLBUI_ip_bind("text-align", on_klbui_ip_text_align);
    KLBUI_ip_bind("text-align:focus", on_klbui_ip_text_align_focus);
    KLBUI_ip_bind("text-align:disabled", on_klbui_ip_text_align_disable);

    // 字体大小 font-size
    KLBUI_ip_bind("font-size", on_klbui_ip_font_size);
    KLBUI_ip_bind("font-size:focus", on_klbui_ip_font_size_focus);
    KLBUI_ip_bind("font-size:disabled", on_klbui_ip_font_size_disable);
    ...
    KLBUI_ip_bind("background-color:disabled", on_klbui_ip_background_color_disable);
    ...
    KLBUI_ip_bind("background-image:disabled", on_klbui_ip_background_image_disable);

    KLBUI_ip_bind("background-image-mode", on_klbui_ip_background_image_mode);
    KLBUI_ip_bind("background-image-mode:focus", on_klbui_ip_background_image_mode_focus);
    KLBUI_ip_bind("background-image-mode:disabled", on_klbui_ip_background_image_mode_disable);

    KLBUI_ip_bind("background-image-color-key", on_klbui_ip_background_image_color_key);
    KLBUI_ip_bind("background-image-color-key:focus", on_klbui_ip_background_image_color_key_focus);
    KLBUI_ip_bind("background-image-color-key:disabled", on_klbui_ip_background_image_color_key_disable);

    // 边框宽度 border
    KLBUI_ip_bind("border-width", on_klbui_ip_border_width);
    KLBUI_ip_bind("border-width:focus", on_klbui_ip_border_width_focus);
    KLBUI_ip_bind("border-width:disabled", on_klbui_ip_border_width_disable);

    KLBUI_ip_bind("border-color", on_klbui_ip_border_color);
    KLBUI_ip_bind("border-color:focus", on_klbui_ip_border_color_focus);
    KLBUI_ip_bind("border-color:disabled", on_klbui_ip_border_color_disable);

    // 私有自定义

    KLBUI_ip_bind("value", on_klbui_ip_value);
    KLBUI_ip_bind("title", on_klbui_ip_value);
}

//////////////////////////////////////////////////////////////////////////
// create, register

static klb_wnd_t* klbui_ip_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    // step1. malloc
    ...
    // step5. 默认使用公用全局CSS属性
    p_ip->p_globalcss = (klbwnd_ip_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBWUI_kip);
...
int klbui_register_kip(klb_gui_t* p_gui)
{
    ...
    return klb_gui_register(p_gui, KLBWUI_kip, klbui_ip_create);
}
