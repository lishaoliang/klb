...
/// @brief  下拉组合框: Lua 注册名 kcombo
typedef struct klbui_combo_t_
{
    klbwnd_combo_t           combo;         ///< 必须首位, 保持内存一致

    klbwnd_combo_css_t*       p_globalcss;    ///< 全局公共的 CSS
    klbwnd_combo_css_t*       p_mycss;        ///< 私有的 CSS
...
static void klbui_combo_destroy(klb_wnd_t* p_wnd)
{
    ...
    if (NULL != p_combo->p_mycss)
    {
        klbwnd_combo_css_deinit(p_combo->p_mycss);
        KLB_FREE(p_combo->p_mycss);
    }
...
static void new_my_css_klbui_combo(klb_wnd_t* p_wnd)
{
    klbui_combo_t* p_combo = (klbui_combo_t*)p_wnd->ctrl;

    if (NULL == p_combo->p_mycss)
    {
        p_combo->p_mycss = KLB_MALLOCZ(klbwnd_combo_css_t, 1, 0);

        klbwnd_combo_css_copy(p_combo->p_mycss, p_combo->p_globalcss);
        klbwnd_combo_set_css(p_wnd, p_combo->p_mycss);
    }
}

static klbwnd_combo_css_t* get_css_klbui_combo(klb_wnd_t* p_wnd)
{
    klbui_combo_t* p_combo = (klbui_combo_t*)p_wnd->ctrl;

    return (NULL != p_combo->p_mycss) ? p_combo->p_mycss : p_combo->p_globalcss;
}

static klbwnd_combo_css_t* check_css_klbui_combo(klb_wnd_t* p_wnd, int method)
{
    if (KLBUI_CSSEX_set == method)
    {
        new_my_css_klbui_combo(p_wnd);
    }

    return get_css_klbui_combo(p_wnd);
}
...
static void globalcss_klbui_combo_margin(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_margin(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_margin_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_margin_top(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_margin_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_margin_right(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_margin_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_margin_bottom(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_margin_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_margin_left(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_padding(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_padding(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_padding_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_padding_top(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_padding_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_padding_right(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_padding_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_padding_bottom(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_padding_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_padding_left(&(p_css->padding), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_color(&(p_css->disable.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_text_align(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_align(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_text_align_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_align(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_text_align_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_text_align(&(p_css->disable.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_font_size(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_font_size(&(p_css->normal.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_font_size_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_font_size(&(p_css->focus.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_font_size_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_font_size(&(p_css->disable.font), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_background_color(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_background_color(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_background_color(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_background_image(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_background_image(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_background_image(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_mode(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_mode_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_mode_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_color_key(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_color_key_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_background_image_color_key_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_border_width(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_border_width(&(p_css->normal.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_border_width_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_border_width(&(p_css->focus.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_border_width_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_border_width(&(p_css->disable.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_border_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_border_color(&(p_css->normal.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_border_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_border_color(&(p_css->focus.border), NULL, method, p_in, p_out);
}

static void globalcss_klbui_combo_border_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;
    klbuicssex_border_color(&(p_css->disable.border), NULL, method, p_in, p_out);
}

static void destroy_globalcss_klbwnd_combo(void* ptr)
{
    klbwnd_combo_css_t* p_css = (klbwnd_combo_css_t*)ptr;

    klbwnd_combo_css_deinit(p_css);
    KLB_FREE(p_css);
}
...
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBWUI_kcombo);
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBWUI_kcombo);

    klbwnd_combo_css_t* p_css = KLB_MALLOCZ(klbwnd_combo_css_t, 1, 0);
    klbwnd_combo_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBWUI_kcombo, p_css, destroy_globalcss_klbwnd_combo);

    KLBUI_GLOBAL_combo_bind("margin", globalcss_klbui_combo_margin);
    KLBUI_GLOBAL_combo_bind("margin-top", globalcss_klbui_combo_margin_top);
    KLBUI_GLOBAL_combo_bind("margin-right", globalcss_klbui_combo_margin_right);
    KLBUI_GLOBAL_combo_bind("margin-bottom", globalcss_klbui_combo_margin_bottom);
    KLBUI_GLOBAL_combo_bind("margin-left", globalcss_klbui_combo_margin_left);
    KLBUI_GLOBAL_combo_bind("padding", globalcss_klbui_combo_padding);
    KLBUI_GLOBAL_combo_bind("padding-top", globalcss_klbui_combo_padding_top);
    KLBUI_GLOBAL_combo_bind("padding-right", globalcss_klbui_combo_padding_right);
    KLBUI_GLOBAL_combo_bind("padding-bottom", globalcss_klbui_combo_padding_bottom);
    KLBUI_GLOBAL_combo_bind("padding-left", globalcss_klbui_combo_padding_left);

    KLBUI_GLOBAL_combo_bind("color", globalcss_klbui_combo_color);
    KLBUI_GLOBAL_combo_bind("color:focus", globalcss_klbui_combo_color_focus);
    KLBUI_GLOBAL_combo_bind("color:disabled", globalcss_klbui_combo_color_disable);

    KLBUI_GLOBAL_combo_bind("text-align", globalcss_klbui_combo_text_align);
    KLBUI_GLOBAL_combo_bind("text-align:focus", globalcss_klbui_combo_text_align_focus);
    KLBUI_GLOBAL_combo_bind("text-align:disabled", globalcss_klbui_combo_text_align_disable);

    KLBUI_GLOBAL_combo_bind("font-size", globalcss_klbui_combo_font_size);
    KLBUI_GLOBAL_combo_bind("font-size:focus", globalcss_klbui_combo_font_size_focus);
    KLBUI_GLOBAL_combo_bind("font-size:disabled", globalcss_klbui_combo_font_size_disable);

    KLBUI_GLOBAL_combo_bind("background-color", globalcss_klbui_combo_background_color);
    KLBUI_GLOBAL_combo_bind("background-color:focus", globalcss_klbui_combo_background_color_focus);
    KLBUI_GLOBAL_combo_bind("background-color:disabled", globalcss_klbui_combo_background_color_disable);

    KLBUI_GLOBAL_combo_bind("background-image", globalcss_klbui_combo_background_image);
    KLBUI_GLOBAL_combo_bind("background-image:focus", globalcss_klbui_combo_background_image_focus);
    KLBUI_GLOBAL_combo_bind("background-image:disabled", globalcss_klbui_combo_background_image_disable);

    KLBUI_GLOBAL_combo_bind("background-image-mode", globalcss_klbui_combo_background_image_mode);
    KLBUI_GLOBAL_combo_bind("background-image-mode:focus", globalcss_klbui_combo_background_image_mode_focus);
    KLBUI_GLOBAL_combo_bind("background-image-mode:disabled", globalcss_klbui_combo_background_image_mode_disable);

    KLBUI_GLOBAL_combo_bind("background-image-color-key", globalcss_klbui_combo_background_image_color_key);
    KLBUI_GLOBAL_combo_bind("background-image-color-key:focus", globalcss_klbui_combo_background_image_color_key_focus);
    KLBUI_GLOBAL_combo_bind("background-image-color-key:disabled", globalcss_klbui_combo_background_image_color_key_disable);

    KLBUI_GLOBAL_combo_bind("border-width", globalcss_klbui_combo_border_width);
    KLBUI_GLOBAL_combo_bind("border-width:focus", globalcss_klbui_combo_border_width_focus);
    KLBUI_GLOBAL_combo_bind("border-width:disabled", globalcss_klbui_combo_border_width_disable);

    KLBUI_GLOBAL_combo_bind("border-color", globalcss_klbui_combo_border_color);
    KLBUI_GLOBAL_combo_bind("border-color:focus", globalcss_klbui_combo_border_color_focus);
    KLBUI_GLOBAL_combo_bind("border-color:disabled", globalcss_klbui_combo_border_color_disable);
...
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_color(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_color_focus(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_color_disable(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_background_image_mode(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_background_image_mode_focus(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_background_image_mode_disable(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_background_image_color_key(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_background_image_color_key_focus(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
static void on_klbui_combo_background_image_color_key_disable(klb_wnd_t* p_wnd, klbui_combo_t* p_combo, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_combo_css_t* p_css = check_css_klbui_combo(p_wnd, method);
...
{
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBWUI_kcombo);
    if (NULL != ptr)
    {
    ...
    ptr = klb_gui_new_css_map(p_gui, KLBWUI_kcombo);
    p_combo->p_func_map = ptr;
    ...
    KLBUI_combo_bind("color", on_klbui_combo_color);
    KLBUI_combo_bind("color:focus", on_klbui_combo_color_focus);
    KLBUI_combo_bind("color:disabled", on_klbui_combo_color_disable);

    KLBUI_combo_bind("text-align", on_klbui_combo_text_align);
    KLBUI_combo_bind("text-align:focus", on_klbui_combo_text_align_focus);
    KLBUI_combo_bind("text-align:disabled", on_klbui_combo_text_align_disable);

    KLBUI_combo_bind("font-size", on_klbui_combo_font_size);
    KLBUI_combo_bind("font-size:focus", on_klbui_combo_font_size_focus);
    KLBUI_combo_bind("font-size:disabled", on_klbui_combo_font_size_disable);
    ...
    KLBUI_combo_bind("background-color:disabled", on_klbui_combo_background_color_disable);
    ...
    KLBUI_combo_bind("background-image:disabled", on_klbui_combo_background_image_disable);

    KLBUI_combo_bind("background-image-mode", on_klbui_combo_background_image_mode);
    KLBUI_combo_bind("background-image-mode:focus", on_klbui_combo_background_image_mode_focus);
    KLBUI_combo_bind("background-image-mode:disabled", on_klbui_combo_background_image_mode_disable);

    KLBUI_combo_bind("background-image-color-key", on_klbui_combo_background_image_color_key);
    KLBUI_combo_bind("background-image-color-key:focus", on_klbui_combo_background_image_color_key_focus);
    KLBUI_combo_bind("background-image-color-key:disabled", on_klbui_combo_background_image_color_key_disable);
    ...
    KLBUI_combo_bind("border-width:disabled", on_klbui_combo_border_width_disable);
    ...
    KLBUI_combo_bind("border-color:disabled", on_klbui_combo_border_color_disable);
...
static klb_wnd_t* klbui_combo_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    ...
    // step5. 默认使用公用全局CSS属性
    p_combo->p_globalcss = (klbwnd_combo_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBWUI_kcombo);
...
int klbui_register_kcombo(klb_gui_t* p_gui)
{
    ...
    return klb_gui_register(p_gui, KLBWUI_kcombo, klbui_combo_create);
}
