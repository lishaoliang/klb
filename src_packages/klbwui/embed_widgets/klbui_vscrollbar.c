...
/// @brief  垂直滚动条: Lua 注册名 kvscrollbar
typedef struct klbui_vscrollbar_t_
{
    klbwnd_vscrollbar_t       vsc;           ///< 必须首位, 保持内存一致

    klbwnd_vscrollbar_css_t*       p_globalcss;    ///< 全局公共的 CSS
    klbwnd_vscrollbar_css_t*       p_mycss;        ///< 私有的 CSS
...
static void klbui_vscrollbar_destroy(klb_wnd_t* p_wnd)
{
    ...
    {
        klbwnd_vscrollbar_css_deinit(p_vsc->p_mycss);
...
static void globalcss_klbui_vscrollbar_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbuicssex_text_color(&(p_css->normal.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbuicssex_text_color(&(p_css->focus.text), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
...
static void globalcss_klbui_vscrollbar_background_image_mode(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_background_image_mode_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_background_image_mode_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbwuicss_background_image_mode(&(p_css->disable.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_background_image_color_key(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->normal.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_background_image_color_key_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
    klbwuicss_background_image_color_key(&(p_css->focus.background), NULL, method, p_in, p_out);
}

static void globalcss_klbui_vscrollbar_background_image_color_key_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = (klbwnd_vscrollbar_css_t*)ptr;
...
static void destroy_globalcss_klbwnd_vscrollbar(void* ptr)
{
    ...
    klbwnd_vscrollbar_css_deinit(p_css);
    KLB_FREE(p_css);
}

#define KLBUI_GLOBAL_vscrollbar_bind(KEY_, FUNC_) { klb_map_set_ptr(ptr, (KEY_), (void*)(FUNC_), NULL); }

static void klbui_vscrollbar_init_globalcss(klb_gui_t* p_gui)
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBWUI_kvscrollbar);
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBWUI_kvscrollbar);

    klbwnd_vscrollbar_css_t* p_css = KLB_MALLOCZ(klbwnd_vscrollbar_css_t, 1, 0);
    klbwnd_vscrollbar_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBWUI_kvscrollbar, p_css, destroy_globalcss_klbwnd_vscrollbar);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("color", globalcss_klbui_vscrollbar_color);
    KLBUI_GLOBAL_vscrollbar_bind("color:focus", globalcss_klbui_vscrollbar_color_focus);
    KLBUI_GLOBAL_vscrollbar_bind("color:disabled", globalcss_klbui_vscrollbar_color_disable);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("text-align:disabled", globalcss_klbui_vscrollbar_text_align_disable);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("font-size:disabled", globalcss_klbui_vscrollbar_font_size_disable);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("background-color:disabled", globalcss_klbui_vscrollbar_background_color_disable);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("background-image:disabled", globalcss_klbui_vscrollbar_background_image_disable);

    KLBUI_GLOBAL_vscrollbar_bind("background-image-mode", globalcss_klbui_vscrollbar_background_image_mode);
    KLBUI_GLOBAL_vscrollbar_bind("background-image-mode:focus", globalcss_klbui_vscrollbar_background_image_mode_focus);
    KLBUI_GLOBAL_vscrollbar_bind("background-image-mode:disabled", globalcss_klbui_vscrollbar_background_image_mode_disable);

    KLBUI_GLOBAL_vscrollbar_bind("background-image-color-key", globalcss_klbui_vscrollbar_background_image_color_key);
    KLBUI_GLOBAL_vscrollbar_bind("background-image-color-key:focus", globalcss_klbui_vscrollbar_background_image_color_key_focus);
    KLBUI_GLOBAL_vscrollbar_bind("background-image-color-key:disabled", globalcss_klbui_vscrollbar_background_image_color_key_disable);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("border-width:disabled", globalcss_klbui_vscrollbar_border_width_disable);
    ...
    KLBUI_GLOBAL_vscrollbar_bind("border-color:disabled", globalcss_klbui_vscrollbar_border_color_disable);
...
static void on_klbui_vscrollbar_color(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_color_focus(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_color_disable(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_background_image_mode(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_background_image_mode_focus(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_background_image_mode_disable(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_background_image_color_key(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_background_image_color_key_focus(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_background_image_color_key_disable(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_vscrollbar_css_t* p_css = check_css_klbui_vscrollbar(p_wnd, method);
...
static void on_klbui_vscrollbar_value(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    ...
    else if (KLBUI_CSSEX_set == method)
    {
        ...
        {
            klbwnd_vscrollbar_set_value(p_wnd, (int)klb_map_idx_to_int64(p_in, start));
        }
        else if (KLB_ADT_uint64 == type)
        {
            klbwnd_vscrollbar_set_value(p_wnd, (int)klb_map_idx_to_uint64(p_in, start));
        }
    }
...
static void on_klbui_vscrollbar_ranges(klb_wnd_t* p_wnd, klbui_vscrollbar_t* p_vsc, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    if (KLBUI_CSSEX_get == method)
    {
        ...
        klb_map_set_int64(p_ranges, "min", p_vsc->vsc.min);
        klb_map_set_int64(p_ranges, "max", p_vsc->vsc.max);
        klb_map_set_int64(p_ranges, "step", p_vsc->vsc.step);
...
{
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBWUI_kvscrollbar);
    if (NULL != ptr)
    {
    ...
    ptr = klb_gui_new_css_map(p_gui, KLBWUI_kvscrollbar);
    p_vsc->p_func_map = ptr;
    ...
    KLBUI_vscrollbar_bind("color", on_klbui_vscrollbar_color);
    KLBUI_vscrollbar_bind("color:focus", on_klbui_vscrollbar_color_focus);
    KLBUI_vscrollbar_bind("color:disabled", on_klbui_vscrollbar_color_disable);
    ...
    KLBUI_vscrollbar_bind("text-align:disabled", on_klbui_vscrollbar_text_align_disable);
    ...
    KLBUI_vscrollbar_bind("font-size:disabled", on_klbui_vscrollbar_font_size_disable);
    ...
    KLBUI_vscrollbar_bind("background-color:disabled", on_klbui_vscrollbar_background_color_disable);
    ...
    KLBUI_vscrollbar_bind("background-image:disabled", on_klbui_vscrollbar_background_image_disable);

    KLBUI_vscrollbar_bind("background-image-mode", on_klbui_vscrollbar_background_image_mode);
    KLBUI_vscrollbar_bind("background-image-mode:focus", on_klbui_vscrollbar_background_image_mode_focus);
    KLBUI_vscrollbar_bind("background-image-mode:disabled", on_klbui_vscrollbar_background_image_mode_disable);

    KLBUI_vscrollbar_bind("background-image-color-key", on_klbui_vscrollbar_background_image_color_key);
    KLBUI_vscrollbar_bind("background-image-color-key:focus", on_klbui_vscrollbar_background_image_color_key_focus);
    KLBUI_vscrollbar_bind("background-image-color-key:disabled", on_klbui_vscrollbar_background_image_color_key_disable);
    ...
    KLBUI_vscrollbar_bind("border-width:disabled", on_klbui_vscrollbar_border_width_disable);
    ...
    KLBUI_vscrollbar_bind("border-color:disabled", on_klbui_vscrollbar_border_color_disable);
...
static klb_wnd_t* klbui_vscrollbar_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    // step1. malloc
    ...
    // step5. 默认使用公用全局CSS属性
    p_vsc->p_globalcss = (klbwnd_vscrollbar_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBWUI_kvscrollbar);
...
{
    klbui_vscrollbar_init_globalcss(p_gui);
    return klb_gui_register(p_gui, KLBWUI_kvscrollbar, klbui_vscrollbar_create);
}
