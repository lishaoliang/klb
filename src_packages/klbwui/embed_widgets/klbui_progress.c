...
/// @brief  进度条: Lua 注册名 kprogress
typedef struct klbui_progress_t_
{
    klbwnd_progress_t           progress;       ///< 必须首位, 保持内存一致

    klbwnd_progress_css_t*      p_globalcss;    ///< 全局公共的 CSS
    klbwnd_progress_css_t*      p_mycss;        ///< 私有的 CSS
...
static void klbui_progress_destroy(klb_wnd_t* p_wnd)
{
    ...
    if (NULL != p_prog->p_mycss)
    {
        klbwnd_progress_css_deinit(p_prog->p_mycss);
        KLB_FREE(p_prog->p_mycss);
    }
...
static void new_my_css_klbui_progress(klb_wnd_t* p_wnd)
{
    klbui_progress_t* p_prog = (klbui_progress_t*)p_wnd->ctrl;

    if (NULL == p_prog->p_mycss)
    {
        p_prog->p_mycss = KLB_MALLOCZ(klbwnd_progress_css_t, 1, 0);

        klbwnd_progress_css_copy(p_prog->p_mycss, p_prog->p_globalcss);
        klbwnd_progress_set_css(p_wnd, p_prog->p_mycss);
    }
}

static klbwnd_progress_css_t* get_css_klbui_progress(klb_wnd_t* p_wnd)
{
    klbui_progress_t* p_prog = (klbui_progress_t*)p_wnd->ctrl;

    return (NULL != p_prog->p_mycss) ? p_prog->p_mycss : p_prog->p_globalcss;
}

static klbwnd_progress_css_t* check_css_klbui_progress(klb_wnd_t* p_wnd, int method)
{
    if (KLBUI_CSSEX_set == method)
    {
        new_my_css_klbui_progress(p_wnd);
    }

    return get_css_klbui_progress(p_wnd);
}
...
static void globalcss_klbui_progress_margin(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;

    klbuicssex_margin(&(p_css->margin), NULL, method, p_in, p_out);
}

static void globalcss_klbui_progress_margin_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_margin_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_margin_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_margin_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_padding(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_padding_top(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_padding_right(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_padding_bottom(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_padding_left(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_text_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_text_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_text_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_text_align(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_text_align_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_text_align_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_font_size(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_font_size_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_font_size_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_mode(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_mode_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_mode_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_color_key(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_color_key_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_background_image_color_key_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_border_width(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_border_width_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_border_width_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_border_color(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_border_color_focus(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void globalcss_klbui_progress_border_color_disable(void* ptr, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;
...
static void destroy_globalcss_klbwnd_progress(void* ptr)
{
    klbwnd_progress_css_t* p_css = (klbwnd_progress_css_t*)ptr;

    klbwnd_progress_css_deinit(p_css);
    KLB_FREE(p_css);
}

#define KLBUI_GLOBAL_progress_bind(KEY_, FUNC_) { klb_map_set_ptr(ptr, (KEY_), (void*)(FUNC_), NULL); }

static void klbui_progress_init_globalcss(klb_gui_t* p_gui)
{
    klb_map_t* ptr = klb_gui_globalcss_map(p_gui, KLBWUI_kprogress);
    ...
    ptr = klb_gui_new_globalcss_map(p_gui, KLBWUI_kprogress);

    klbwnd_progress_css_t* p_css = KLB_MALLOCZ(klbwnd_progress_css_t, 1, 0);
    klbwnd_progress_css_init(p_css, p_gui);
    klb_gui_globalcss_set_ptr(p_gui, KLBWUI_kprogress, p_css, destroy_globalcss_klbwnd_progress);

    KLBUI_GLOBAL_progress_bind("margin", globalcss_klbui_progress_margin);
    KLBUI_GLOBAL_progress_bind("margin-top", globalcss_klbui_progress_margin_top);
    KLBUI_GLOBAL_progress_bind("margin-right", globalcss_klbui_progress_margin_right);
    KLBUI_GLOBAL_progress_bind("margin-bottom", globalcss_klbui_progress_margin_bottom);
    KLBUI_GLOBAL_progress_bind("margin-left", globalcss_klbui_progress_margin_left);

    KLBUI_GLOBAL_progress_bind("padding", globalcss_klbui_progress_padding);
    KLBUI_GLOBAL_progress_bind("padding-top", globalcss_klbui_progress_padding_top);
    KLBUI_GLOBAL_progress_bind("padding-right", globalcss_klbui_progress_padding_right);
    KLBUI_GLOBAL_progress_bind("padding-bottom", globalcss_klbui_progress_padding_bottom);
    KLBUI_GLOBAL_progress_bind("padding-left", globalcss_klbui_progress_padding_left);

    KLBUI_GLOBAL_progress_bind("color", globalcss_klbui_progress_text_color);
    KLBUI_GLOBAL_progress_bind("color:focus", globalcss_klbui_progress_text_color_focus);
    KLBUI_GLOBAL_progress_bind("color:disabled", globalcss_klbui_progress_text_color_disable);

    KLBUI_GLOBAL_progress_bind("text-align", globalcss_klbui_progress_text_align);
    KLBUI_GLOBAL_progress_bind("text-align:focus", globalcss_klbui_progress_text_align_focus);
    KLBUI_GLOBAL_progress_bind("text-align:disabled", globalcss_klbui_progress_text_align_disable);

    KLBUI_GLOBAL_progress_bind("font-size", globalcss_klbui_progress_font_size);
    KLBUI_GLOBAL_progress_bind("font-size:focus", globalcss_klbui_progress_font_size_focus);
    KLBUI_GLOBAL_progress_bind("font-size:disabled", globalcss_klbui_progress_font_size_disable);

    KLBUI_GLOBAL_progress_bind("background-color", globalcss_klbui_progress_background_color);
    KLBUI_GLOBAL_progress_bind("background-color:focus", globalcss_klbui_progress_background_color_focus);
    KLBUI_GLOBAL_progress_bind("background-color:disabled", globalcss_klbui_progress_background_color_disable);

    KLBUI_GLOBAL_progress_bind("background-image", globalcss_klbui_progress_background_image);
    KLBUI_GLOBAL_progress_bind("background-image:focus", globalcss_klbui_progress_background_image_focus);
    KLBUI_GLOBAL_progress_bind("background-image:disabled", globalcss_klbui_progress_background_image_disable);

    KLBUI_GLOBAL_progress_bind("background-image-mode", globalcss_klbui_progress_background_image_mode);
    KLBUI_GLOBAL_progress_bind("background-image-mode:focus", globalcss_klbui_progress_background_image_mode_focus);
    KLBUI_GLOBAL_progress_bind("background-image-mode:disabled", globalcss_klbui_progress_background_image_mode_disable);

    KLBUI_GLOBAL_progress_bind("background-image-color-key", globalcss_klbui_progress_background_image_color_key);
    KLBUI_GLOBAL_progress_bind("background-image-color-key:focus", globalcss_klbui_progress_background_image_color_key_focus);
    KLBUI_GLOBAL_progress_bind("background-image-color-key:disabled", globalcss_klbui_progress_background_image_color_key_disable);

    KLBUI_GLOBAL_progress_bind("border-width", globalcss_klbui_progress_border_width);
    KLBUI_GLOBAL_progress_bind("border-width:focus", globalcss_klbui_progress_border_width_focus);
    KLBUI_GLOBAL_progress_bind("border-width:disabled", globalcss_klbui_progress_border_width_disable);

    KLBUI_GLOBAL_progress_bind("border-color", globalcss_klbui_progress_border_color);
    KLBUI_GLOBAL_progress_bind("border-color:focus", globalcss_klbui_progress_border_color_focus);
    KLBUI_GLOBAL_progress_bind("border-color:disabled", globalcss_klbui_progress_border_color_disable);
}
...
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
static void on_klbui_progress_background_image_mode(klb_wnd_t* p_wnd, klbui_progress_t* p_prog, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
static void on_klbui_progress_background_image_mode_focus(klb_wnd_t* p_wnd, klbui_progress_t* p_prog, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
static void on_klbui_progress_background_image_mode_disable(klb_wnd_t* p_wnd, klbui_progress_t* p_prog, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
static void on_klbui_progress_background_image_color_key(klb_wnd_t* p_wnd, klbui_progress_t* p_prog, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
static void on_klbui_progress_background_image_color_key_focus(klb_wnd_t* p_wnd, klbui_progress_t* p_prog, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
static void on_klbui_progress_background_image_color_key_disable(klb_wnd_t* p_wnd, klbui_progress_t* p_prog, int method, const klb_map_t* p_in, klb_map_t* p_out)
{
    klbwnd_progress_css_t* p_css = check_css_klbui_progress(p_wnd, method);
...
{
    klb_map_t* ptr = klb_gui_css_map(p_gui, KLBWUI_kprogress);
    if (NULL != ptr)
    {
    ...
    ptr = klb_gui_new_css_map(p_gui, KLBWUI_kprogress);
    p_prog->p_func_map = ptr;
    ...
    KLBUI_progress_bind("color:disabled", on_klbui_progress_text_color_disable);
    ...
    KLBUI_progress_bind("text-align:disabled", on_klbui_progress_text_align_disable);
    ...
    KLBUI_progress_bind("font-size:disabled", on_klbui_progress_font_size_disable);
    ...
    KLBUI_progress_bind("background-color:disabled", on_klbui_progress_background_color_disable);
    ...
    KLBUI_progress_bind("background-image:disabled", on_klbui_progress_background_image_disable);

    KLBUI_progress_bind("background-image-mode", on_klbui_progress_background_image_mode);
    KLBUI_progress_bind("background-image-mode:focus", on_klbui_progress_background_image_mode_focus);
    KLBUI_progress_bind("background-image-mode:disabled", on_klbui_progress_background_image_mode_disable);

    KLBUI_progress_bind("background-image-color-key", on_klbui_progress_background_image_color_key);
    KLBUI_progress_bind("background-image-color-key:focus", on_klbui_progress_background_image_color_key_focus);
    KLBUI_progress_bind("background-image-color-key:disabled", on_klbui_progress_background_image_color_key_disable);
    ...
    KLBUI_progress_bind("border-width:disabled", on_klbui_progress_border_width_disable);
    ...
    KLBUI_progress_bind("border-color:disabled", on_klbui_progress_border_color_disable);
...
static klb_wnd_t* klbui_progress_create(klb_gui_t* p_gui, int x, int y, int w, int h)
{
    // step1. malloc
    ...
    // step5. 默认使用公用全局CSS属性
    p_prog->p_globalcss = (klbwnd_progress_css_t*)klb_gui_globalcss_get_ptr(p_gui, KLBWUI_kprogress);
    klbwnd_progress_set_css(p_wnd, p_prog->p_globalcss);
...
{
    klbui_progress_init_globalcss(p_gui);
    return klb_gui_register(p_gui, KLBWUI_kprogress, klbui_progress_create);
}
